...
brew install overcode # macOS і Linux (рекомендовано, завжди актуально)
brew install overcode              # macOS і Linux (офіційна формула Homebrew, оновлюється рідше)
sudo pacman -S overcode            # Arch Linux (Stable)
paru -S overcode-bin               # Arch Linux (Latest from AUR)
mise use -g overcode               # Будь-яка ОС
nix run nixpkgs#overcode           # або github:ConnorSawaya/overcode для найновішої dev-гілки
```
...
Overcode також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/ConnorSawaya/overcode/releases) або [overcode.ai/download](https://github.com/ConnorSawaya/overcode/releases).
...
1. `$OVERCODE_INSTALL_DIR` - Користувацький каталог встановлення
2. `$XDG_BIN_DIR` - Шлях, сумісний зі специфікацією XDG Base Directory
3. `$HOME/bin` - Стандартний каталог користувацьких бінарників (якщо існує або його можна створити)
4. `$HOME/.overcode/bin` - Резервний варіант за замовчуванням
...
Overcode містить два вбудовані агенти, між якими можна перемикатися клавішею `Tab`.
...
Якщо ви хочете зробити внесок в Overcode, будь ласка, прочитайте нашу [документацію для контриб'юторів](./CONTRIBUTING.md) перед надсиланням pull request.

### Проєкти на базі Overcode

Якщо ви працюєте над проєктом, пов'язаним з Overcode, і використовуєте "overcode" у назві, наприклад "overcode-dashboard" або "overcode-mobile", додайте примітку до свого README.
Уточніть, що цей проєкт не створений командою Overcode і жодним чином не афілійований із нами.

---

**Приєднуйтеся до нашої спільноти** [Discord](https://discord.gg/overcode) | [X.com](https://x.com/overcode)
