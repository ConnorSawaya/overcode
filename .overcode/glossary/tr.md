...
- `Overcode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `overcode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Overcode` in prose, `overcode` only for exact technical identifiers
...
- Avoid changing `overcode` to `Overcode` inside commands, URLs, package names, or code literals
