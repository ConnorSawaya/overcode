...
- `Overcode` (preserve casing in prose; keep `overcode` only when it is part of commands, package names, paths, or code)
- `Overcode Zen`
- `Overcode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `overcode` in prose when referring to the product name; use `Overcode`
