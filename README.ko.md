...
brew install overcode # macOS 및 Linux (권장, 항상 최신)
brew install overcode              # macOS 및 Linux (공식 brew formula, 업데이트 빈도 낮음)
sudo pacman -S overcode            # Arch Linux (Stable)
paru -S overcode-bin               # Arch Linux (Latest from AUR)
mise use -g overcode               # 어떤 OS든
nix run nixpkgs#overcode           # 또는 github:ConnorSawaya/overcode 로 최신 dev 브랜치
```
...
Overcode 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/ConnorSawaya/overcode/releases) 에서 직접 다운로드하거나 [overcode.ai/download](https://github.com/ConnorSawaya/overcode/releases) 를 이용하세요.
...
Overcode 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
Overcode 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.

### Overcode 기반으로 만들기

Overcode 와 관련된 프로젝트를 진행하면서 이름에 "overcode"(예: "overcode-dashboard" 또는 "overcode-mobile") 를 포함한다면, README 에 해당 프로젝트가 Overcode 팀이 만든 것이 아니며 어떤 방식으로도 우리와 제휴되어 있지 않다는 점을 명시해 주세요.

---

**커뮤니티에 참여하기** [Discord](https://discord.gg/overcode) | [X.com](https://x.com/overcode)
