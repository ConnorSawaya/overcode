...
[![OpenCode Terminal UI](packages/web/src/assets/lander/screenshot.png)](https://github.com/ConnorSawaya/overcode/releases)
...
```bash
git clone https://github.com/ConnorSawaya/overcode.git && cd overcode && bun install
