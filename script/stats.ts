...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/ConnorSawaya/overcode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for ConnorSawaya/overcode...\n")
...
console.log("Fetching npm all-time downloads for overcode-ai...\n")
const npmDownloads = await fetchNpmDownloads("overcode-ai")
