...
brew install overcode # macOS and Linux (recommended, always up to date)
brew install overcode              # macOS and Linux (official brew formula, updated less)
sudo pacman -S overcode            # Arch Linux (Stable)
paru -S overcode-bin               # Arch Linux (Latest from AUR)
mise use -g overcode               # Any OS
nix run nixpkgs#overcode           # or github:ConnorSawaya/overcode for latest dev branch
```
...
Overcode ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/ConnorSawaya/overcode/releases) অথবা [overcode.ai/download](https://github.com/ConnorSawaya/overcode/releases) থেকে ডাউনলোড করুন।
...
1. `$OVERCODE_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.overcode/bin` - ডিফল্ট ফলব্যাক
...
Overcode এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
আপনি যদি Overcode এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### Overcode এর উপর বিল্ডিং (Building on Overcode)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা Overcode এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "overcode" ব্যবহার করেন, উদাহরণস্বরূপ "overcode-dashboard" বা "overcode-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি Overcode দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/overcode) | [X.com](https://x.com/overcode)
