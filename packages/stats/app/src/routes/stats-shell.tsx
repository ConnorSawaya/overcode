import overcodeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  href: "https://github.com/ConnorSawaya/overcode",
  apiHref: "https://api.github.com/repos/ConnorSawaya/overcode",
  fallbackStars: "195K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "overcode:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://github.com/ConnorSawaya/overcode/">
            <strong>{i18n.t("header.tryOvercode")}</strong>
          </a>
          <button
...
function OvercodeMark() {
  return (
    <svg data-slot="overcode-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://github.com/ConnorSawaya/overcode/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://github.com/ConnorSawaya/overcode/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@overcode.ai", label: i18n.t("footer.contact") },
    { href: "https://github.com/ConnorSawaya/overcode/discussions", label: i18n.t("footer.community") },
    { href: "https://x.com/overcode", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://github.com/ConnorSawaya/overcode" aria-label={i18n.t("footer.homeAria")}>
          <OvercodeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={overcodeWordmarkDark} alt="Overcode" />
          <button
