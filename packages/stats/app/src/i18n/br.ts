export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Overcode Data",
  "app.description":
    "Explore o uso do Overcode em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Overcode Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Overcode no GitHub",
  "header.github": "GitHub",
  "header.tryOvercode": "Experimente o Overcode",
  ...
  "footer.homeAria": "Início do Overcode",
  ...
  "modal.title": "Newsletter do Overcode",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Overcode.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Overcode por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Overcode Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Overcode, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Overcode.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Overcode",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Overcode",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Overcode nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Overcode Data",
  "model.description":
    "Veja dados de uso de {{model}} no Overcode, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Overcode aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Overcode da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Overcode da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Overcode na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Overcode, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Overcode.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Overcode na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Overcode na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Overcode.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do Overcode correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Overcode.",
