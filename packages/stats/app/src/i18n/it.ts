export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Overcode Data",
  "app.description":
    "Esplora l'utilizzo di Overcode nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Overcode Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Overcode su GitHub",
  "header.github": "GitHub",
  "header.tryOvercode": "Prova Overcode",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Overcode.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Overcode per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Overcode Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Overcode, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Overcode.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Overcode",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Overcode",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Overcode negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Overcode Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Overcode, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Overcode appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Overcode della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Overcode della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Overcode nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Overcode, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Overcode.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Overcode nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Overcode nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Overcode.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica Overcode corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token Overcode.",
