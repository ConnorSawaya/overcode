export const dict = {
  "app.title": "Rankingi użycia modeli AI | Overcode Data",
  "app.description":
    "Przeglądaj użycie Overcode w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Overcode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Overcode na GitHub",
  "header.github": "GitHub",
  "header.tryOvercode": "Wypróbuj Overcode",
  ...
  "footer.homeAria": "Strona główna Overcode",
  ...
  "home.topModelsDescription": "Użycie modeli w Overcode.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Overcode według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Overcode Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Overcode, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Overcode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Overcode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Overcode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Overcode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Overcode Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Overcode, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Overcode pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Overcode z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Overcode z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Overcode w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Overcode, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Overcode.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Overcode w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Overcode w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Overcode.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne Overcode nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Overcode.",
