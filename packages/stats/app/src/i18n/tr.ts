export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Overcode Data",
  "app.description":
    "Overcode kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Overcode Data logosu",
  ...
  "header.githubAria": "GitHub'da Overcode'a yıldız ver",
  "header.github": "GitHub",
  "header.tryOvercode": "Overcode'u dene",
  ...
  "footer.homeAria": "Overcode ana sayfası",
  ...
  "home.topModelsDescription": "Overcode genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Overcode kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Overcode Data",
  "lab.description":
    "Overcode'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Overcode kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Overcode'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Overcode kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Overcode token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Overcode Data",
  "model.description":
    "{{model}} için Overcode kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Overcode kullanımı görünür.",
  "model.unranked": "Geçen haftaki Overcode kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Overcode kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Overcode kullanımı yok.",
  ...
  "model.overviewDescription": "Son Overcode tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Overcode kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Overcode token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Overcode kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Overcode oturum yapısı.",
  ...
  "model.noGeoDescription": "Bu modelle eşleşen Overcode coğrafi satırı yok.",
  "model.peersDescription": "Son Overcode token hacmine göre yakındaki modeller.",
