...
const en = {
  "app.title": "AI Model Usage Rankings | Overcode Data",
  "app.description":
    "Explore Overcode usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Overcode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Overcode on GitHub",
  "header.github": "GitHub",
  "header.tryOvercode": "Try Overcode",
  ...
  "home.topModelsDescription": "Usage of models across Overcode.",
  ...
  "home.uniqueUsersDescription": "Daily unique Overcode users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Overcode Data",
  "lab.description":
    "Compare {{lab}} models used in Overcode, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Overcode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Overcode",
  ...
  "lab.shareOfUsage": "{{share}} of recent Overcode usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Overcode Data",
  "model.description":
    "View {{model}} Overcode usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Overcode usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Overcode usage",
  "model.ranked": "Ranked #{{rank}} across last week's Overcode usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Overcode usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Overcode usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No Overcode geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent Overcode token volume.",
