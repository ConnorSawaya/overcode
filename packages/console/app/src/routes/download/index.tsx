        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              >
                <code>
                  git clone https://<strong>github.com/ConnorSawaya/overcode.git</strong> && cd overcode && bun
                  install
                </code>
                <CopyStatus />
              </button>
              <button
                data-component="cli-row"
                onClick={handleCopyClick("bun run --cwd packages/opencode src/index.ts")}
              >
                <code>
                  bun run --cwd <strong>packages/opencode</strong> src/index.ts
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                data-component="cli-row"
                onClick={handleCopyClick("https://github.com/ConnorSawaya/overcode/releases")}
              >
                <code>
                  <strong>github.com/ConnorSawaya/overcode/releases</strong>
                </code>
                <CopyStatus />
              </button>
