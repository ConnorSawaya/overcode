        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g overcode-ai")}>
                <code>
                  npm i -g <strong>overcode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g overcode-ai")}>
                <code>
                  bun add -g <strong>overcode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/overcode")}>
                <code>
                  brew install <strong>anomalyco/tap/overcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S overcode")}>
                <code>
                  paru -S <strong>overcode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask overcode-desktop")}>
                <code>
                  brew install --cask <strong>overcode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
