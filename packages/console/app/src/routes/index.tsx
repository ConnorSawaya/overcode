            ...
            <div data-slot="installation">
              ...
              >
                <Tabs.List data-slot="tablist">
                  ...
                  <Tabs.Trigger value="run" data-slot="tab">
                    run
                  </Tabs.Trigger>
                  <Tabs.Trigger value="desktop" data-slot="tab">
                    desktop
                  </Tabs.Trigger>
                  <Tabs.Indicator />
                </Tabs.List>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="source">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span data-slot="command-script">
                        ...
                        <span data-slot="highlight">github.com/ConnorSawaya/overcode.git</span>
                        <span> && cd overcode && bun install</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  <Tabs.Content as="pre" data-slot="panel" value="run">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        <span data-slot="protocol">bun run --cwd packages/opencode </span>
                        <span data-slot="highlight">src/index.ts</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  <Tabs.Content as="pre" data-slot="panel" value="desktop">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        <span data-slot="protocol">https://</span>
                        <span data-slot="highlight">github.com/ConnorSawaya/overcode/releases</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
