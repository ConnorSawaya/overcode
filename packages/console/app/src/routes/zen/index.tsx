...
import compareVideo from "../../asset/lander/overcode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/overcode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="overcode:auth" content={loggedin() ? "true" : "false"} />
