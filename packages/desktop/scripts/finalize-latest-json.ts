...
const releaseId = process.env.OVERCODE_RELEASE
if (!releaseId) throw new Error("OVERCODE_RELEASE is required")

const version = process.env.OVERCODE_VERSION
if (!version) throw new Error("OVERCODE_VERSION is required")
...
const macxTarGz = "overcode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "overcode-desktop-mac-arm64.app.tar.gz"
