export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Overcoden uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Overcoden versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Overcoden uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'overcode'-komentoa.",
