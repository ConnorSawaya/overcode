export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Overcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Overcode. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "Interfejs CLI zainstalowano w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia „overcode”.",
