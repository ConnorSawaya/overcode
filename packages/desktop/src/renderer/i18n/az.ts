export const dict = {
  ...
  "desktop.updater.none.message": "Artıq Overcode-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "Overcode-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} ünvanına quraşdırıldı\n\n'overcode' əmrindən istifadə etmək üçün terminalı yenidən başladın.",
