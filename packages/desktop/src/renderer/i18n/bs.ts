export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Overcode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Overcode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nPonovo pokreni terminal da bi koristio komandu 'overcode'.",
