export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi Overcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace Overcode. Chcete ji nainstalovat a aplikaci znovu spustit?",
  ...
  "desktop.cli.installed.message":
    "CLI nainstalováno do {{path}}\n\nRestartujte svůj terminál, abyste mohli použít příkaz 'overcode'.",
