export const dict = {
  ...
  "desktop.updater.none.message": "Már az Overcode legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Overcode {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
  ...
  "desktop.cli.installed.message":
    "A CLI telepítési helye: {{path}}\n\nIndítsa újra a terminált az 'overcode' parancs használatához.",
