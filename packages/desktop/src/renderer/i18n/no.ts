export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Overcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Overcode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert i {{path}}\n\nStart terminalen på nytt for å bruke 'overcode'-kommandoen.",
