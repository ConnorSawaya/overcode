export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Overcode-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Overcode-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
  ...
  "desktop.cli.installed.message":
    "CLI-ն տեղադրված է {{path}}-ում\n\nՎերագործարկեք ձեր տերմինալը՝ «overcode» հրամանն օգտագործելու համար:",
