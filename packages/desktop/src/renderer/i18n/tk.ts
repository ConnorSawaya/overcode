export const dict = {
  ...
  "desktop.updater.none.message": "Overcode-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "Overcode-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'overcode' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
