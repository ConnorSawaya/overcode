export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Overcode versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Overcode versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
  ...
  "desktop.cli.installed.message":
    "CLI instalēts uz {{path}}\n\nRestartējiet termināli, lai izmantotu komandu 'overcode'.",
