export const dict = {
  ...
  "desktop.updater.none.message": "Používate najnovšiu verziu Overcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzia {{version}} Overcode bola stiahnutá. Chcete ju nainštalovať a reštartovať?",
  ...
  "desktop.cli.installed.message":
    "CLI bolo nainštalované do {{path}}\n\nReštartujte terminál, aby ste mohli používať príkaz 'overcode'.",
