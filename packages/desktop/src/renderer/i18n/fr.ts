export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Overcode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Overcode a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
  ...
  "desktop.cli.installed.message":
    "Interface en ligne de commande installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'overcode'.",
