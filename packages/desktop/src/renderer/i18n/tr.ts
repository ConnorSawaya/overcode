export const dict = {
  ...
  "desktop.updater.none.message": "Overcode'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Overcode'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'overcode' komutunu kullanmak için terminalinizi yeniden başlatın.",
