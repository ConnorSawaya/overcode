export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'Overcode",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'Overcode. Voleu instal·lar-la i reiniciar l'aplicació?",
  ...
  "desktop.cli.installed.message":
    "CLI instal·lada a {{path}}\n\nReinicieu el terminal per utilitzar l'ordre 'overcode'.",
