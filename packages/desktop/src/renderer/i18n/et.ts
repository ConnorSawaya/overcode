export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Overcode uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Overcode'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „overcode” kasutamiseks taaskäivitage terminal.",
