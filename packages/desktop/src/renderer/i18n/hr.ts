export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Overcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Overcode. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI instaliran na {{path}}\n\nPonovno pokrenite terminal da biste koristili naredbu 'overcode'.",
