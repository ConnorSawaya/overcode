export const dict = {
  ...
  "desktop.updater.none.message": "თქვენ უკვე იყენებთ Overcode-ის უახლეს ვერსიას",
  ...
  "desktop.updater.downloaded.prompt":
    "Overcode-ის {{version}} ვერსია ჩამოტვირთულია, გსურთ მისი ინსტალაცია და ხელახლა გაშვება?",
  ...
  "desktop.cli.installed.message":
    "CLI დაინსტალირებულია {{path}}-ზე\n\nგადატვირთეთ ტერმინალი „overcode“ ბრძანების გამოსაყენებლად.",
