export const dict = {
  ...
  "desktop.updater.none.message": "Веќе ја користите најновата верзија на Overcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзијата {{version}} од Overcode е преземена, дали сакате да ја инсталирате и повторно да ја стартувате?",
  ...
  "desktop.cli.installed.message":
    "CLI инсталиран на {{path}}\n\nРестартирајте го терминалот за да ја користите командата „overcode“.",
