export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Overcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Overcode is gedownload. Wil je deze installeren en Overcode opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'overcode' te gebruiken.",
