export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av Overcode.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av Overcode er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
  ...
  "desktop.cli.installed.message":
    "CLI sett upp í {{path}}\n\nEndurbyrja terminalin fyri at brúka skipanina 'overcode'.",
