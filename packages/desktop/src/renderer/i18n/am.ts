export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የOvercode ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከOvercode ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
