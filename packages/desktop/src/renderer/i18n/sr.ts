export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију Overcode",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од Overcode је преузета, да ли желите да је инсталирате и поново покренете?",
  ...
  "desktop.cli.installed.message":
    "CLI инсталиран на {{path}}\n\nПоново покрените терминал да бисте користили команду 'overcode'.",
