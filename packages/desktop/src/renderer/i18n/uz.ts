export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon Overcode ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "Overcodening {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'overcode' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
