...
class Database extends Context.Service<Database, DatabaseShape>()("@overcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@overcode/example/UserStore") {
