...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OVERCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/overcode/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/overcode (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/overcode/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/overcode/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const OVERCODE_DB|OVERCODE_DB|OVERCODE_DEV|Global\\.Path\\.data|data =" in packages/overcode/src (115 matches)',
  },
] as const
