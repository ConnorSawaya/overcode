...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[Overcode](https://github.com/ConnorSawaya/overcode)")).toBe(
    '<p><a href="https://github.com/ConnorSawaya/overcode" class="external-link" target="_blank" rel="noopener noreferrer">Overcode</a></p>\n',
  )
})
