export const dict: Record<string, string> = {
  "ui.computerUse.title": "Computer use",
  "ui.computerUse.action": "Computer: {{action}}",
  "ui.computerUse.action.screenshot": "Screenshot",
  "ui.computerUse.action.move": "Move pointer",
  "ui.computerUse.action.click": "Click",
  "ui.computerUse.action.doubleClick": "Double-click",
  "ui.computerUse.action.drag": "Drag",
  "ui.computerUse.action.scroll": "Scroll",
  "ui.computerUse.action.type": "Type text",
  "ui.computerUse.action.press": "Press keys",
  "ui.computerUse.action.finish": "Finish",
  "ui.computerUse.action.unknown": "Action",
  "ui.computerUse.status.pending": "Pending",
  "ui.computerUse.status.running": "Running",
  "ui.computerUse.status.completed": "Completed",
  "ui.computerUse.audit": "Desktop activity. Typed text, key contents, and screenshots are omitted from this compact audit view.",
  "ui.computerUse.frame": "Screenshot frame: {{frameId}}",
  "ui.computerUse.detail": "{{name}}: {{value}}",
  "ui.computerUse.characters": "Text length: {{count}}",
  "ui.computerUse.stopped": "Desktop access stopped.",
  ...
  "dialog.usageExceeded.freeTier.description":
    "Subscribe to Overcode Go for reliable access to the best open-source models for $10/month.",
