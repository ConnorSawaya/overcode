---
title: LSP-servere
description: Overcode integreres med dine LSP-servere.
---

Overcode kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Overcode leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `OVERCODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og overcode åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din overcode-konfiguration.
