---
title: TUI
description: Brug af Overcode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Overcode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Overcode starter TUI for den nuværende mappe.
...
Når du bruger Overcode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Overcode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Overcode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `overcode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Overcode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `overcode.default`.
