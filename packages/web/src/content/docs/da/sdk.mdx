...
Brug den til at bygge integrasjoner og kontrollere overcode programmatisk.
...
Opret en forekomst av overcode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `overcode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av overcode, kan du oprete en klientforekomst for at koble til den:
