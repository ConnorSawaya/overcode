...
Kreiraj `.overcode/commands/test.md`:
...
Možete dodati prilagođene komande kroz Overcode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Overcode [config](/docs/config):
...
- Globalno: `~/.config/overcode/commands/`
- Po projektu: `.overcode/commands/`
...
Overcode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
