...
Prilagođeni alati su funkcije koje kreirate i koje LLM može pozvati tokom razgovora. Oni rade zajedno sa [ugrađenim overcode](/docs/tools) alatima kao što su `read`, `write` i `bash`.
...
- Lokalno postavljanjem u `.overcode/tools/` direktorij vašeg projekta.
- Ili globalno, postavljanjem u `~/.config/overcode/tools/`.
