---
title: TUI
description: Korištenje korisničkog interfejsa Overcode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Overcode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Overcode pokreće TUI za trenutni direktorij.
...
Kada koristite Overcode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Overcode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Overcode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `overcode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Overcode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `overcode.default`.
