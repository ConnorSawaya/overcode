---
title: SDK
description: Typsicherer JS-Client fuer den overcode-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das overcode JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und overcode programmatisch steuern.
...
Erstelle eine overcode-Instanz:
...
`overcode.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn overcode bereits laeuft, kannst du nur einen Client erstellen und verbinden:
