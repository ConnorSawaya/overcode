---
title: Teilen
description: Teile Overcode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Overcode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Overcode Folgendes:
...
Overcode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Overcode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`overcode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du overcode in deiner Organisation einsetzt.
