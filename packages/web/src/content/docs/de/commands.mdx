...
Erstellen Sie `.overcode/commands/test.md`:

```md title=".overcode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Overcode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Overcode [config](/docs/config):

```json title="overcode.jsonc" {4-12}
{
...
- Global: `~/.config/overcode/commands/`
- Pro Projekt: `.overcode/commands/`

```markdown title="~/.config/overcode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".overcode/commands/component.md"
---
...
```md title=".overcode/commands/create-file.md"
---
...
```md title=".overcode/commands/analyze-coverage.md"
---
...
```md title=".overcode/commands/review-changes.md"
---
...
```md title=".overcode/commands/review-component.md"
---
...
Overcode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
