...
Crea `.overcode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Overcode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Overcode:
...
- Globale: `~/.config/overcode/commands/`
- Per progetto: `.overcode/commands/`
...
overcode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
