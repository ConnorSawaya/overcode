...
description: Crea strumenti che l'LLM puo chiamare in overcode.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di overcode come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.overcode/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/overcode/tools/`.
