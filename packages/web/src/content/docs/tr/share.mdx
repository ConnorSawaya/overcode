---
title: Paylasim
description: overcode konusmalarini genel baglantilarla paylasin.
---

overcode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda overcode:
...
overcode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak overcode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `overcode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda overcode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
