---
title: Özel Araçlar
description: LLM'un overcode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. overcode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.overcode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/overcode/tools/` içine yerleştirerek.
