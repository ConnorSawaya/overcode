...
Crie `.overcode/commands/test.md`:
...
Você pode adicionar comandos personalizados através da configuração do overcode ou criando arquivos markdown no diretório `commands/`.

---

### JSON

Use a opção `command` na sua [configuração](/docs/config) do overcode:
...
overcode inclui vários comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [saiba mais](/docs/tui#commands).
