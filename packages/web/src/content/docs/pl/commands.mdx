...
Utwórz `.overcode/commands/test.md`:
...
Możesz zdefiniować polecenia w `overcode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji overcode:
...
- Globalnie: `~/.config/overcode/commands/`
- Na projekt: `.overcode/commands/`
...
overcode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
