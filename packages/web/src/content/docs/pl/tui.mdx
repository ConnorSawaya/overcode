---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala overcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

overcode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie overcode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI overcode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do overcode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij overcode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `overcode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Overcode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `overcode.default`.
