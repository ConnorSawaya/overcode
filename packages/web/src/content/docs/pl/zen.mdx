---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Overcode.
---
...
Overcode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Overcode.

Zen działa jak każdy inny dostawca w Overcode. Logujesz się do Overcode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Overcode.
:::
...
Overcode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Overcode Zen działa jak każdy inny dostawca w Overcode.

1. Logujesz się do **<a href={console}>Overcode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Overcode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Overcode używa formatu
`overcode/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`overcode/gpt-5.5`.
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. Overcode używa tych modeli do generowania tytułów sesji.
...
- MiMo-V2.5 Free jest dostępny w Overcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling 3.0 Flash Fin Free jest dostępny w Overcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w Overcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3.5 Lightning Free jest dostępny w Overcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Overcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Muse Spark 1.3 Contributor Free jest dostępny w Overcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Muse Spark 1.2 Contributor Free jest dostępny w Overcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Overcode także dowolnego innego dostawcy.
