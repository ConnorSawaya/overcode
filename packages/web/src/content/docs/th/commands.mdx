...
สร้าง `.overcode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Overcode:
...
- ระดับผู้ใช้ (Global): `~/.config/overcode/commands/`
- ระดับโปรเจ็กต์: `.overcode/commands/`
...
Overcode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
