...
Crear `.overcode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Overcode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Overcode [config](/docs/config):
...
- Por proyecto: `.overcode/commands/`
...
overcode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
