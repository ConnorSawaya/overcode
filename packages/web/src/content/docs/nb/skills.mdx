...
Agentferdigheter lar Overcode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går overcode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
overcode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `overcode.json`:
