---
title: TUI
description: Bruke overcode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Overcode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Overcode starter TUI for gjeldende katalog.
...
Når du bruker Overcode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Overcode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Overcode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `overcode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Overcode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `overcode.default`.
