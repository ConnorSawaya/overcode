...
Opprett `.overcode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Overcode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Overcode [config](/docs/config):
...
- Per prosjekt: `.overcode/commands/`
...
Overcode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
