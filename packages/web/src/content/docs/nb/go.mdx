...
Overcode Go er et lavkostnadsabonnement til **$10/måned** som gir deg pålitelig tilgang til populære åpne kodemodeller.

Go fungerer som enhver annen leverandør i Overcode. Du abonnerer på Overcode Go og
...
Overcode Go gir deg tilgang til disse modellene for **$10/måned**.

---

## Hvordan det fungerer

Overcode Go fungerer som enhver annen leverandør i Overcode.

1. Du logger inn på **<a href={console}>Overcode Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `Overcode Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på Overcode Go.
:::
...
Overcode Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din Overcode-konfigurasjon
bruker formatet `overcode-go/<model-id>`. For eksempel, for Kimi K3, vil du
bruke `overcode-go/kimi-k3` i konfigurasjonen din.
...
Vi opprettet Overcode Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med Overcode også.
