...
export class Service extends Context.Service<Service, Interface>()("@overcode/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.OVERCODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
