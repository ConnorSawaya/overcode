...
/** Preserve the complete legacy metadata carried by the canonical Session row for bridge events. */
export function toV1Info(row: typeof SessionTable.$inferSelect): SessionV1.SessionInfo {
  const summary =
