...
declare const OVERCODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof OVERCODE_CLI_NAME === "string" ? OVERCODE_CLI_NAME : "overcode", {
  description: "Overcode 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
