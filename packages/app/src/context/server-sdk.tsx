...
import { createApiForServer, createSdkForServer, serverRequestHeaders, type ServerApi } from "@/utils/server"
...
function createServerSdkContextBase(server: ServerConnection.Any, scope: ServerScope): ServerSDKBase {
  ...
  const request = async (input: { path: string; method: "DELETE" | "POST"; directory?: string }) => {
    const headers = serverRequestHeaders(server.http, input.directory)
