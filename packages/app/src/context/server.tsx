...
// Keep a durable tombstone history for synchronized project closes. The UI
// still renders only RECENTLY_CLOSED_DISPLAY_LIMIT entries, so this does not
// make the sidebar larger while allowing an offline device to catch up later.
const RECENTLY_CLOSED_HISTORY_LIMIT = 10_000
