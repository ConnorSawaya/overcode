export const dict = {
  ...
  "desktop.menu.documentation": "Overcode დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "Overcode მენიუ",
  ...
  "desktop.recovery.loadFailed": "Overcode ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "Overcode ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "Overcode არ პასუხობს",
  ...
  "desktop.wsl.error.installOpencode": "Overcode ინსტალაცია ვერ მოხერხდა",
  "desktop.wsl.error.alreadyAdded": "{{distro}} უკვე დამატებულია",
  "desktop.wsl.error.overcodeMissing": "overcode არ არის დაინსტალირებული ამ დისტროში",
  "desktop.wsl.error.overcodeCannotRun": "overcode დაინსტალირებულია, მაგრამ ვერ გაშვება",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Overcode განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "dialog.provider.overcode.note": "კურირებული მოდელები, მათ შორის Claude, GPT, Gemini და სხვა",
  "dialog.provider.overcode.tagline": "სანდო ოპტიმიზებული მოდელები",
  "dialog.provider.overcodeGo.tagline": "დაბალფასიანი გამოწერა ყველასთვის",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია Overcode",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები Overcode-ში.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen გაძლევთ წვდომას კოდირების აგენტებისთვის საიმედო ოპტიმიზირებული მოდელების კურირებულ კომპლექტზე.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "ეწვიეთ ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " თქვენი API გასაღების შესაგროვებლად.",
  "provider.connect.oauth.code.visit.prefix": "ეწვიეთ ",
  "provider.connect.oauth.code.visit.link": "ეს ბმული",
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები Overcode-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები Overcode-ში.",
  ...
  "dialog.plugins.empty": "პლაგინები კონფიგურირებულია overcode.json-ში",
  ...
  "dialog.server.description": "გადართეთ რომელ Overcode სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingOpencode": "შემოწმებულია Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "შემოწმებულია Overcode-ში {{distro}}...",
  "wsl.onboarding.updatingOpencode": "განახლება Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Overcode განახლება ხდება {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "განახლება Overcode {{distro}}-ში.",
  "wsl.onboarding.updateOpencode": "განახლება Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode მზად არის {{distro}}-ში.",
  "wsl.onboarding.overcodeReady": "Overcode მზად არის.",
  "wsl.onboarding.installOpencodeIn": "დააინსტალირეთ Overcode {{distro}}-ში.",
  "wsl.onboarding.installOpencode": "დააინსტალირეთ Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ Overcode შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "Overcode ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით Overcode.",
  ...
  "help.tabs.introduction": "Overcode სამუშაო მაგიდა ახლა აგებულია ჩანართების გარშემო.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Overcode-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა Overcode გუნდს",
  ...
  "error.chain.checkConfig": "შეამოწმეთ თქვენი კონფიგურაცია (overcode.json) პროვაიდერის/მოდელების სახელები",
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, Overcode ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "Overcode მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "Overcode სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით Overcode სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა Overcode",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება Overcode თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა Overcode სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის Overcode თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც Overcode გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ Overcode-ის უახლეს ვერსიას.",
