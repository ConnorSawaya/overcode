export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Overcode",
  "desktop.recovery.terminated": "توقفت نافذة Overcode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Overcode لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Overcode",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.overcodeMissing": "overcode غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.overcodeCannotRun": "overcode مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Overcode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.overcode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.overcode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.overcodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Overcode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "يمنحك Overcode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Overcode.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في overcode.json",
  ...
  "dialog.server.description": "تبديل خادم Overcode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Overcode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Overcode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Overcode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode جاهز في {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Overcode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Overcode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Overcode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Overcode.",
  ...
  "help.tabs.introduction": "أصبح Overcode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Overcode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Overcode",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (overcode.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Overcode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Overcode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Overcode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Overcode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Overcode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Overcode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Overcode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Overcode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Overcode.",
