export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "Overcode कागजात",
  ...
  "desktop.menu.ariaLabel": "Overcode मेनु",
  ...
  "desktop.recovery.loadFailed": "Overcode लोड हुन सकेन",
  "desktop.recovery.terminated": "Overcode विन्डो अप्रत्याशित रूपमा समाप्त भयो",
  "desktop.recovery.unresponsive": "Overcode ले प्रतिक्रिया दिइरहेको छैन",
  ...
  "desktop.wsl.error.installOpencode": "Overcode स्थापना असफल भयो",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहिले नै थपिएको छ",
  "desktop.wsl.error.overcodeMissing": "Opencode यस distro मा स्थापित छैन",
  "desktop.wsl.error.overcodeCannotRun": "overcode स्थापित छ तर चलाउन सकिएन",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode {{distro}} मा स्थापित छैन",
  "desktop.wsl.error.updateVersion":
    "Overcode अद्यावधिक समाप्त भयो तर {{distro}} ले अझै पनि रिपोर्ट गर्छ {{installed}}; अपेक्षित {{expected}}",
  ...
  "dialog.provider.overcode.note": "Claude, GPT, Gemini र थप सहित क्युरेट गरिएका मोडेलहरू",
  "dialog.provider.overcode.tagline": "भरपर्दो अनुकूलित मोडेलहरू",
  "dialog.provider.overcodeGo.tagline": "सबैको लागि कम लागत सदस्यता",
  ...
  "dialog.model.unpaid.freeModels.title": "Overcode द्वारा प्रदान गरिएको नि:शुल्क मोडेलहरू",
  ...
  "provider.connect.apiKey.description":
    "आफ्नो खाता जडान गर्न आफ्नो {{provider}} API कुञ्जी प्रविष्ट गर्नुहोस् र Overcode मा {{provider}} मोडेलहरू प्रयोग गर्नुहोस्।",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen ले तपाईंलाई कोडिङ एजेन्टहरूका लागि भरपर्दो अनुकूलित मोडेलहरूको क्युरेट गरिएको सेटमा पहुँच दिन्छ।",
  ...
  "provider.connect.overcodeZen.visit.prefix": "भ्रमण गर्नुहोस्",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": "तपाईँको API कुञ्जी सङ्कलन गर्न।",
  "provider.connect.oauth.code.visit.prefix": "भ्रमण गर्नुहोस्",
  "provider.connect.oauth.code.visit.link": "यो लिङ्क",
  "provider.connect.oauth.code.visit.suffix":
    "आफ्नो खाता जडान गर्न र Overcode मा {{provider}} मोडेलहरू प्रयोग गर्न आफ्नो प्राधिकरण कोड सङ्कलन गर्न।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "र आफ्नो खाता जडान गर्न तलको कोड प्रविष्ट गर्नुहोस् र {{provider}} मोडेलहरू Overcode मा प्रयोग गर्नुहोस्।",
  ...
  "dialog.plugins.empty": "overcode.json मा कन्फिगर गरिएका प्लगइनहरू",
  ...
  "dialog.server.description": "यो एप जडान भएको Overcode सर्भरलाई स्विच गर्नुहोस्।",
  ...
  "wsl.onboarding.checkingOpencode": "Overcode जाँच गर्दै...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} मा Overcode जाँच गर्दै...",
  "wsl.onboarding.updatingOpencode": "अद्यावधिक गर्दै Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} मा Overcode अद्यावधिक गर्दै...",
  "wsl.onboarding.updateOpencodeIn": "अपडेट गर्नुहोस् Overcode {{distro}} मा।",
  "wsl.onboarding.updateOpencode": "अपडेट गर्नुहोस् Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode {{distro}} मा तयार छ।",
  "wsl.onboarding.overcodeReady": "Overcode तयार छ।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} मा Overcode स्थापना गर्नुहोस्।",
  "wsl.onboarding.installOpencode": "Overcode स्थापना गर्नुहोस्",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode स्थापित छैन",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Linux को लागि सबसिस्टम) Overcode ले WSL सर्भर थप्न अघि आवश्यक छ।",
  "wsl.onboarding.wslUnavailable.title": "WSL उपलब्ध छैन",
  "wsl.onboarding.wslUnavailable.description": "Overcode ले यो मेसिनमा WSL प्रमाणित गर्न सकेन।",
  "wsl.onboarding.installWsl": "WSL स्थापना गर्नुहोस्",
  "wsl.onboarding.windowsRestartRequired":
    "WSL स्थापना पूरा गर्न Windows पुन: सुरु गर्नुहोस्, त्यसपछि Overcode पुन: खोल्नुहोस्।",
  ...
  "help.tabs.introduction": "Overcode डेस्कटप अब ट्याब वरिपरि बनाइएको छ।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Overcode ({{version}}) को नयाँ संस्करण अब स्थापना गर्न उपलब्ध छ।",
  ...
  "error.page.report.prefix": "कृपया यो त्रुटि Overcode टोलीलाई रिपोर्ट गर्नुहोस्",
  ...
  "error.chain.checkConfig": "आफ्नो कन्फिगरेसन (overcode.json) प्रदायक/मोडेल नामहरू जाँच गर्नुहोस्",
  "error.chain.mcpFailed":
    'MCP सर्भर "{{name}}" असफल भयो। नोट गर्नुहोस्, Overcode ले अझै पनि MCP प्रमाणीकरणलाई समर्थन गर्दैन।',
  ...
  "sidebar.gettingStarted.line1": "Overcode मा नि:शुल्क मोडेलहरू समावेश छन् ताकि तपाईं तुरुन्तै सुरु गर्न सक्नुहुन्छ।",
  ...
  "app.name.desktop": "Overcode डेस्कटप",
  ...
  "settings.desktop.wsl.description": "Overcode सर्भर भित्र WSL Windows मा चलाउनुहोस्।",
  ...
  "settings.general.row.language.description": "Overcode को लागि प्रदर्शन भाषा परिवर्तन गर्नुहोस्",
  ...
  "settings.general.row.appearance.description": "आफ्नो यन्त्रमा Overcode कस्तो देखिन्छ अनुकूलित गर्नुहोस्",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description":
    "Overcode ले प्रणाली, उज्यालो वा गाढा विषयवस्तुलाई फलो गर्छ कि गर्दैन भन्ने छनौट गर्नुहोस्",
  "settings.general.row.theme.title": "विषयवस्तु",
  "settings.general.row.theme.description": "कसरी Overcode विषयवस्तुलाई अनुकूलित गर्नुहोस्।",
  ...
  "settings.updates.row.startup.description": "Overcode सुरु हुँदा अद्यावधिकहरूको लागि स्वचालित रूपमा जाँच गर्नुहोस्",
  ...
  "settings.updates.toast.latest.description": "तपाईं Overcode को नवीनतम संस्करण चलाइरहनुभएको छ।",
