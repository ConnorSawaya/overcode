export const dict = {
  ...
  "desktop.recovery.loadFailed": "Overcode gagal dimuat",
  "desktop.recovery.terminated": "Jendela Overcode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Overcode tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Overcode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.overcodeMissing": "overcode belum terinstal di distro ini",
  "desktop.wsl.error.overcodeCannotRun": "overcode telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Overcode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.overcode.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.overcode.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.overcodeGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Overcode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Overcode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di overcode.json",
  ...
  "dialog.server.description": "Ganti server Overcode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Overcode di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Overcode di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Overcode di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode siap di {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Overcode di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Overcode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Overcode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Overcode.",
  ...
  "help.tabs.introduction": "Overcode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Overcode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Overcode",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (overcode.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Overcode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Overcode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Overcode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Overcode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Overcode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Overcode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Overcode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Overcode.",
