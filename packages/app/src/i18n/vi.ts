export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Overcode",
  ...
  "desktop.recovery.loadFailed": "Không tải được Overcode",
  "desktop.recovery.terminated": "Cửa sổ Overcode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Overcode không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Overcode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.overcodeMissing": "overcode chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.overcodeCannotRun": "overcode đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Overcode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.overcode.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.overcode.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.overcodeGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Overcode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Truy cập ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Overcode.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong overcode.json",
  ...
  "dialog.server.description": "Chuyển máy chủ Overcode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Overcode trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Overcode trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Overcode trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Overcode trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Overcode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Overcode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Overcode.",
  ...
  "help.tabs.introduction": "Overcode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Overcode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Overcode",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (overcode.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Overcode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Overcode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Overcode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Overcode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Overcode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Overcode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Overcode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Overcode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Overcode.",
