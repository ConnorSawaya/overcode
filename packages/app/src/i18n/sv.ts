export const dict = {
  ...
  "desktop.recovery.loadFailed": "Overcode kunde inte läsas in",
  "desktop.recovery.terminated": "Overcode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Overcode svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Overcode misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.overcodeMissing": "overcode är inte installerat i den här distributionen",
  "desktop.wsl.error.overcodeCannotRun": "overcode är installerat men kunde inte köras",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Overcode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.overcode.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.overcode.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.overcodeGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Overcode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.overcodeZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.overcodeZen.visit.prefix": "Besök ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Overcode.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i overcode.json",
  ...
  "dialog.server.description": "Växla vilken Overcode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Overcode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Overcode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Overcode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode är redo i {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Overcode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Overcode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Overcode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Overcode igen.",
  ...
  "help.tabs.introduction": "Overcode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Overcode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Overcode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (overcode.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Overcode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Overcode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Overcode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Overcode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Overcode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Overcode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Overcodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Overcode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Overcode.",
