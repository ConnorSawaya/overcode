export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Overcode",
  ...
  "desktop.recovery.loadFailed": "Overcode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Overcode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Overcode tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Overcode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.overcodeMissing": "overcode tidak dipasang dalam distro ini",
  "desktop.wsl.error.overcodeCannotRun": "overcode dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Overcode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.overcode.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.overcode.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.overcodeGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Overcode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Layari",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Overcode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam overcode.json",
  ...
  "dialog.server.description": "Tukar pelayan Overcode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Overcode dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Overcode dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Overcode dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Overcode dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Overcode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Overcode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Overcode.",
  ...
  "help.tabs.introduction": "Overcode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Overcode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Overcode",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (overcode.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Overcode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Overcode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Overcode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Overcode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Overcode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Overcode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Overcode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Overcode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Overcode.",
