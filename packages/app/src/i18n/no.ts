...
export const dict = {
  ...
  "desktop.menu.documentation": "Overcode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Overcode-meny",
  ...
  "desktop.recovery.loadFailed": "Overcode kunne ikke lastes inn",
  "desktop.recovery.terminated": "Overcode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Overcode svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Overcode mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.overcodeMissing": "overcode er ikke installert i denne distribusjonen",
  "desktop.wsl.error.overcodeCannotRun": "overcode er installert, men kunne ikke kjøres",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Overcode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.overcode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.overcode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.overcodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Overcode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Besøk ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Overcode.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i overcode.json",
  ...
  "dialog.server.description": "Bytt hvilken Overcode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Overcode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Overcode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (overcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Overcode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Overcode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Overcode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Overcode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Overcode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Overcode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Overcode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Overcode starter",
  ...
  "settings.updates.toast.latest.title": "Overcode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Overcode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Overcode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Overcode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Overcode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode er klar i {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Overcode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Overcode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Overcode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Overcode på nytt.",
  ...
  "help.tabs.introduction": "Overcode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
