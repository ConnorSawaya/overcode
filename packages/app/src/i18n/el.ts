export const dict = {
  ...
  "desktop.menu.documentation": "Overcode Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Overcode μενού",
  ...
  "desktop.recovery.loadFailed": "Overcode απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Overcode το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Overcode δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "Overcode η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.overcodeMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.overcodeCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Overcode η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.provider.overcode.note": "Επιμελημένα μοντέλα συμπεριλαμβανομένων των Claude, GPT, Gemini και άλλων",
  "dialog.provider.overcode.tagline": "Αξιόπιστα βελτιστοποιημένα μοντέλα",
  "dialog.provider.overcodeGo.tagline": "Συνδρομή χαμηλού κόστους για όλους",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από Overcode",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Επίσκεψη ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " για τη συλλογή του κλειδιού σας API.",
  "provider.connect.oauth.code.visit.prefix": "Επίσκεψη ",
  "provider.connect.oauth.code.visit.link": "αυτός ο σύνδεσμος",
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Overcode.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο overcode.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Overcode συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Overcode σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Overcode σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Overcode σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Overcode στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Overcode να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Overcode δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Overcode.",
  ...
  "help.tabs.introduction": "Overcode Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Overcode ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Overcode",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (overcode.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Overcode δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "Overcode περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "Overcode Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Overcode μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Overcode",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Overcode στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Overcode ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Overcode.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Overcode",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Overcode.",
