export const dict = {
  ...
  "desktop.menu.documentation": "Overcode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Overcode menyusi",
  ...
  "desktop.recovery.loadFailed": "Overcode yuklanmadi",
  "desktop.recovery.terminated": "Overcode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Overcode javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Overcode oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.overcodeMissing": "Opencode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.overcodeCannotRun": "overcode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Overcode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.overcode.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.overcode.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.overcodeGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Overcode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Overcode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Overcode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Overcode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "overcode.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Overcode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Overcode tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Overcode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Overcode yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Overcode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Overcode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Overcode-ni yangilang",
  "wsl.onboarding.overcodeReadyIn": "Overcode {{distro}} da tayyor.",
  "wsl.onboarding.overcodeReady": "Overcode tayyor.",
  "wsl.onboarding.installOpencodeIn": "Overcode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Overcode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Overcode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Overcode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Overcode-ni qayta oching.",
  ...
  "help.tabs.introduction": "Overcode Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Overcode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Overcode jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (overcode.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Overcode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Overcode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Overcode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Overcode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Overcode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Overcode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Overcode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Overcode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Overcode oxirgi versiyasini ishga tushiryapsiz.",
