...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Overcode se nije uspio učitati",
  "Prozor aplikacije Overcode neočekivano je zatvoren",
  "Overcode ne reagira",
  ...
  "Instalacija aplikacije Overcode nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "overcode nije instaliran u ovoj distribuciji",
  "overcode je instaliran, ali se ne može pokrenuti",
  "Overcode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Overcode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.overcode.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.overcode.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.overcodeGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Overcode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Posjetiti",
  "provider.connect.overcodeZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Overcode.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u overcode.json",
  ...
  "dialog.server.description": "Promijenite na koji se Overcode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Overcode u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Overcode u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Overcode u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode je spreman u {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Overcode u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Overcode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Overcode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Overcode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Overcode.",
  ...
  "help.tabs.introduction": "Radna površina Overcode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Overcode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Overcode timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (overcode.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Overcode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Overcode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Overcode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Overcode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Overcode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Overcode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Overcode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Overcode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Overcode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Overcode.",
