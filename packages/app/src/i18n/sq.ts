export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Overcode",
  ...
  "desktop.menu.ariaLabel": "Menuja Overcode",
  ...
  "desktop.recovery.loadFailed": "Overcode nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Overcode u mbyll papritur",
  "desktop.recovery.unresponsive": "Overcode nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i Overcode dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.overcodeMissing": "Opencode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.overcodeCannotRun": "Opencode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Overcode përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.overcode.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.overcode.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.overcodeGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga Overcode",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Vizitoni ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Overcode.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në overcode.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server Overcode lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon Overcode në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Overcode po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson Overcode në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso Overcode në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode është gati në {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni Overcode në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Overcode të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Overcode nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Overcode.",
  ...
  "help.tabs.introduction": "Overcode Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Overcode ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Overcode",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (overcode.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Overcode nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "Overcode përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Overcode brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Overcode",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Overcode në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse Overcode ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Overcode.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Overcode",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Overcode.",
