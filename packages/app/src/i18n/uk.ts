export const dict = {
  ...
  "desktop.menu.documentation": "Документація Overcode",
  ...
  "desktop.menu.ariaLabel": "Меню Overcode",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Overcode",
  "desktop.recovery.terminated": "Роботу вікна Overcode несподівано завершено",
  "desktop.recovery.unresponsive": "Overcode не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити Overcode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.overcodeMissing": "overcode не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.overcodeCannotRun": "overcode встановлено, але його не вдалося запустити",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Overcode завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.overcode.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.overcode.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.overcodeGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Overcode",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Відвідайте ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Overcode.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в overcode.json",
  ...
  "dialog.server.description": "Перемкніть сервер Overcode, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка Overcode у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення Overcode у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть Overcode у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode готовий до роботи у {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть Overcode у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Overcode потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Overcode не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Overcode.",
  ...
  "help.tabs.introduction": "Overcode Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Overcode ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Overcode",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (overcode.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Overcode ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Overcode містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Overcode всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Overcode",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Overcode на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Overcode використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Overcode.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Overcode",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Overcode.",
