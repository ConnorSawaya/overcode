export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "Overcode ডকুমেন্টেশন",
  ...
  "desktop.menu.ariaLabel": "Overcode মেনু",
  ...
  "desktop.recovery.loadFailed": "Overcode লোড হতে ব্যর্থ হয়েছে৷",
  "desktop.recovery.terminated": "Overcode উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে",
  "desktop.recovery.unresponsive": "Overcode সাড়া দিচ্ছে না",
  ...
  "desktop.wsl.error.installOpencode": "Overcode ইনস্টলেশন ব্যর্থ হয়েছে৷",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ইতিমধ্যেই যোগ করা হয়েছে৷",
  "desktop.wsl.error.overcodeMissing": "এই ডিস্ট্রোতে overcode ইনস্টল করা নেই",
  "desktop.wsl.error.overcodeCannotRun": "overcode ইনস্টল করা আছে কিন্তু চালানো যায়নি",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode {{distro}} এ ইনস্টল করা নেই",
  "desktop.wsl.error.updateVersion":
    "Overcode আপডেট শেষ হয়েছে কিন্তু {{distro}} এখনও রিপোর্ট করে {{installed}}; প্রত্যাশিত {{expected}}",
  ...
  "dialog.provider.overcode.note": "Claude, GPT, Gemini এবং আরও অনেক কিছু সহ কিউরেট করা মডেল",
  "dialog.provider.overcode.tagline": "নির্ভরযোগ্য অপ্টিমাইজ করা মডেল",
  "dialog.provider.overcodeGo.tagline": "সবার জন্য কম খরচে সাবস্ক্রিপশন",
  ...
  "dialog.model.unpaid.freeModels.title": "বিনামূল্যের মডেলগুলি Overcode দ্বারা প্রদত্ত",
  ...
  "provider.connect.apiKey.description":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার {{provider}} API কী লিখুন এবং Overcode-এ {{provider}} মডেলগুলি ব্যবহার করুন৷",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen আপনাকে কোডিং এজেন্টের জন্য নির্ভরযোগ্য অপ্টিমাইজ করা মডেলের একটি কিউরেটেড সেটে অ্যাক্সেস দেয়।",
  ...
  "provider.connect.overcodeZen.visit.prefix": "ভিজিট করুন",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": "আপনার API কী সংগ্রহ করতে।",
  "provider.connect.oauth.code.visit.prefix": "ভিজিট করুন",
  "provider.connect.oauth.code.visit.link": "এই লিঙ্ক",
  "provider.connect.oauth.code.visit.suffix":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার অনুমোদন কোড সংগ্রহ করতে এবং {{provider}} মডেলগুলি Overcode-এ ব্যবহার করতে।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "এবং আপনার অ্যাকাউন্ট সংযোগ করতে নীচের কোডটি লিখুন এবং {{provider}} মডেলগুলি Overcode-এ ব্যবহার করুন৷",
  ...
  "dialog.plugins.empty": "overcode.json এ কনফিগার করা প্লাগইন",
  ...
  "dialog.server.description": "এই অ্যাপটি কোন Overcode সার্ভারের সাথে সংযোগ করে তা পরিবর্তন করুন।",
  ...
  "wsl.onboarding.checkingOpencode": "Overcode পরীক্ষা করা হচ্ছে...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} এ Overcode চেক করা হচ্ছে...",
  "wsl.onboarding.updatingOpencode": "আপডেট করা হচ্ছে Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-এ Overcode আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-এ Overcode আপডেট করুন।",
  "wsl.onboarding.updateOpencode": "Overcode আপডেট করুন",
  "wsl.onboarding.overcodeReadyIn": "Overcode {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.overcodeReady": "Overcode প্রস্তুত।",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-এ Overcode ইনস্টল করুন।",
  "wsl.onboarding.installOpencode": "Overcode ইনস্টল করুন",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode ইনস্টল করা নেই",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux এর জন্য Windows সাবসিস্টেম) Overcode একটি WSL সার্ভার যোগ করার আগে প্রয়োজন",
  "wsl.onboarding.wslUnavailable.title": "WSL অনুপলব্ধ",
  "wsl.onboarding.wslUnavailable.description": "Overcode এই মেশিনে WSL যাচাই করতে পারেনি।",
  "wsl.onboarding.installWsl": "WSL ইনস্টল করুন",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ইনস্টল করা শেষ করতে Windows পুনরায় চালু করুন, তারপর Overcode আবার খুলুন।",
  ...
  "help.tabs.introduction": "Overcode ডেস্কটপ এখন ট্যাবের চারপাশে তৈরি।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Overcode ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷",
  ...
  "error.page.report.prefix": "অনুগ্রহ করে এই ত্রুটিটি Overcode টিমের কাছে রিপোর্ট করুন",
  ...
  "error.chain.checkConfig": "আপনার কনফিগারেশন (overcode.json) প্রদানকারী/মডেলের নাম পরীক্ষা করুন",
  "error.chain.mcpFailed":
    'MCP সার্ভার "{{name}}" ব্যর্থ হয়েছে৷ মনে রাখবেন, Overcode এখনও MCP প্রমাণীকরণ সমর্থন করে না।',
  ...
  "sidebar.gettingStarted.line1": "Overcode বিনামূল্যে মডেল অন্তর্ভুক্ত করে যাতে আপনি অবিলম্বে শুরু করতে পারেন।",
  ...
  "app.name.desktop": "Overcode ডেস্কটপ",
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে Overcode সার্ভার চালান।",
  ...
  "settings.general.row.language.description": "Overcode-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন",
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে Overcode কেমন দেখায় তা কাস্টমাইজ করুন",
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "Overcode সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন",
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে Overcode থিম করা হয় তা কাস্টমাইজ করুন।",
  ...
  "settings.updates.row.startup.description": "Overcode চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন",
  ...
  "settings.updates.toast.latest.description": "আপনি Overcode এর সর্বশেষ সংস্করণ চালাচ্ছেন।",
