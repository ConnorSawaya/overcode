export const dict = {
  ...
  "dialog.provider.overcode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.overcode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.overcodeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Overcode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.overcodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.overcodeZen.visit.prefix": "Besøg ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Overcode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i overcode.json",
  ...
  "dialog.server.description": "Skift hvilken Overcode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Overcode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Overcode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Overcode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Overcode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Overcode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Overcode igen.",
  ...
  "toast.update.description": "En ny version af Overcode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Overcode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (overcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Overcode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Overcode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Overcode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Overcode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Overcode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Overcode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Overcodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Overcode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Overcode.",
  ...
  "desktop.recovery.loadFailed": "Overcode kunne ikke indlæses",
  "desktop.recovery.terminated": "Overcode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Overcode mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.overcodeMissing": "overcode er ikke installeret i denne distribution",
  "desktop.wsl.error.overcodeCannotRun": "overcode er installeret, men kunne ikke køre",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Overcode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Overcode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
