export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Overcode",
  ...
  "desktop.menu.ariaLabel": "Overcode meni",
  ...
  "desktop.recovery.loadFailed": "Overcode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Overcode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Overcode ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Overcode-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.overcodeMissing": "overcode nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.overcodeCannotRun": "overcode je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Overcode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.overcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.overcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.overcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Overcode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Overcode-u.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Overcode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Overcode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u overcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se Overcode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Overcode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Overcode u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Overcode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Overcode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Overcode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Overcode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Overcode.",
  ...
  "help.tabs.introduction": "Overcode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Overcode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Overcode timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (overcode.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Overcode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Overcode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Overcode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Overcode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Overcode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Overcode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Overcode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Overcode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Overcode-a.",
