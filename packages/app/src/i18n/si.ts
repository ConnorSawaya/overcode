export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "Overcode ලේඛනගත කිරීම",
  ...
  "desktop.menu.ariaLabel": "Overcode මෙනුව",
  ...
  "desktop.recovery.loadFailed": "Overcode පූරණය කිරීමට අසමත් විය",
  "desktop.recovery.terminated": "Overcode කවුළුව අනපේක්ෂිත ලෙස අවසන් විය",
  "desktop.recovery.unresponsive": "Overcode ප්‍රතිචාර නොදක්වයි",
  ...
  "desktop.wsl.error.installOpencode": "Overcode ස්ථාපනය අසාර්ථක විය",
  "desktop.wsl.error.alreadyAdded": "{{distro}} දැනටමත් එක් කර ඇත",
  "desktop.wsl.error.overcodeMissing": "මෙම distro හි overcode ස්ථාපනය කර නොමැත",
  "desktop.wsl.error.overcodeCannotRun": "overcode ස්ථාපනය කර ඇති නමුත් ධාවනය කල නොහැක",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode {{distro}} හි ස්ථාපනය කර නැත",
  "desktop.wsl.error.updateVersion":
    "Overcode යාවත්කාලීන කිරීම අවසන් නමුත් {{distro}} තවමත් වාර්තා කරන්නේ {{installed}}; අපේක්ෂිත {{expected}}",
  ...
  "dialog.provider.overcode.note": "Claude, GPT, Gemini සහ තවත් දේ ඇතුළුව සංවෘත ආකෘති",
  "dialog.provider.overcode.tagline": "විශ්වසනීය ප්රශස්ත මාදිලි",
  "dialog.provider.overcodeGo.tagline": "සෑම කෙනෙකුටම අඩු වියදම් දායකත්වයක්",
  ...
  "dialog.model.unpaid.freeModels.title": "Overcode මඟින් සපයනු ලබන නිදහස් මාදිලි",
  ...
  "provider.connect.apiKey.description":
    "ඔබගේ ගිණුම සම්බන්ධ කිරීමට ඔබගේ {{provider}} API යතුර ඇතුලත් කරන්න සහ Overcode හි {{provider}} මාදිලි භාවිතා කරන්න.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen ඔබට කේතීකරණ නියෝජිතයන් සඳහා විශ්වාසදායක ප්‍රශස්ත මාදිලි සමූහයකට ප්‍රවේශය ලබා දෙයි.",
  "provider.connect.overcodeZen.line2":
    "තනි API යතුරක් සමඟින් ඔබට Claude, GPT, Gemini, GLM සහ තවත් ආකෘති වෙත ප්‍රවේශය ලැබෙනු ඇත.",
  "provider.connect.overcodeZen.visit.prefix": "පිවිසෙන්න",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": "ඔබගේ API යතුර එකතු කිරීමට.",
  "provider.connect.oauth.code.visit.prefix": "පිවිසෙන්න",
  "provider.connect.oauth.code.visit.link": "මෙම සබැඳිය",
  "provider.connect.oauth.code.visit.suffix":
    "ඔබගේ ගිණුම සම්බන්ධ කිරීමට සහ Overcode හි {{provider}} මාදිලි භාවිතා කිරීමට ඔබගේ අවසර කේතය එකතු කිරීමට.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "සහ ඔබගේ ගිණුම සම්බන්ධ කිරීමට පහත කේතය ඇතුළු කර {{provider}} මාදිලි Overcode තුළ භාවිතා කරන්න.",
  ...
  "dialog.plugins.empty": "ප්ලගීන overcode.json හි වින්‍යාස කර ඇත",
  ...
  "dialog.server.description": "මෙම යෙදුම සම්බන්ධ වන්නේ කුමන Overcode සේවාදායකයටද යන්න මාරු කරන්න.",
  ...
  "wsl.onboarding.checkingOpencode": "Overcode පරීක්ෂා කරමින්...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} හි Overcode පරීක්ෂා කරමින්...",
  "wsl.onboarding.updatingOpencode": "Overcode යාවත්කාලීන කරමින්...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} හි Overcode යාවත්කාලීන කරමින්...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} හි Overcode යාවත්කාලීන කරන්න.",
  "wsl.onboarding.updateOpencode": "Overcode යාවත්කාලීන කරන්න",
  "wsl.onboarding.overcodeReadyIn": "Overcode {{distro}} හි සූදානම්ය.",
  "wsl.onboarding.overcodeReady": "Overcode සූදානම්.",
  "wsl.onboarding.installOpencodeIn": "{{distro}} හි Overcode ස්ථාපනය කරන්න.",
  "wsl.onboarding.installOpencode": "Overcode ස්ථාපනය කරන්න",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode ස්ථාපනය කර නැත",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Linux සඳහා උප පද්ධතිය) Overcode WSL සේවාදායකයක් එක් කිරීමට පෙර අවශ්‍ය වේ",
  "wsl.onboarding.wslUnavailable.title": "WSL නොමැත",
  "wsl.onboarding.wslUnavailable.description": "Overcode හට මෙම යන්ත්‍රයේ WSL සත්‍යාපනය කළ නොහැක.",
  "wsl.onboarding.installWsl": "WSL ස්ථාපනය කරන්න",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ස්ථාපනය අවසන් කිරීමට Windows නැවත අරඹන්න, පසුව Overcode නැවත විවෘත කරන්න.",
  ...
  "help.tabs.introduction": "Overcode ඩෙස්ක්ටොප් එක දැන් ටැබ් වටා ගොඩනගා ඇත.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Overcode හි නව අනුවාදයක් ({{version}}) ස්ථාපනය කිරීමට දැන් තිබේ.",
  ...
  "error.page.report.prefix": "කරුණාකර මෙම දෝෂය Overcode කණ්ඩායමට වාර්තා කරන්න",
  ...
  "error.chain.checkConfig": "ඔබගේ වින්‍යාසය (overcode.json) සපයන්නා/ආදර්ශ නම් පරීක්ෂා කරන්න",
  "error.chain.mcpFailed": 'MCP සේවාදායකය "{{name}}" අසාර්ථක විය. සටහන, Overcode තවමත් MCP සත්‍යාපනයට සහය නොදක්වයි.',
  ...
  "sidebar.gettingStarted.line1": "Overcode නොමිලේ ආකෘති ඇතුළත් වන නිසා ඔබට වහාම ආරම්භ කළ හැක.",
  ...
  "app.name.desktop": "Overcode ඩෙස්ක්ටොප්",
  ...
  "settings.desktop.wsl.description": "Windows හි WSL තුළ Overcode සේවාදායකය ධාවනය කරන්න.",
  ...
  "settings.general.row.language.description": "Overcode සඳහා සංදර්ශක භාෂාව වෙනස් කරන්න",
  ...
  "settings.general.row.appearance.description": "ඔබගේ උපාංගයේ Overcode පෙනෙන ආකාරය අභිරුචිකරණය කරන්න",
  "settings.general.row.colorScheme.title": "වර්ණ පටිපාටිය",
  "settings.general.row.colorScheme.description": "Overcode පද්ධතිය, ආලෝකය හෝ අඳුරු තේමාව අනුගමනය කරන්නේද යන්න තෝරන්න",
  "settings.general.row.theme.title": "තේමාව",
  "settings.general.row.theme.description": "Overcode තේමා කර ඇති ආකාරය අභිරුචිකරණය කරන්න.",
  ...
  "settings.updates.row.startup.description": "Overcode දියත් කරන විට යාවත්කාලීන සඳහා ස්වයංක්‍රීයව පරීක්ෂා කරන්න",
  ...
  "settings.updates.toast.latest.description": "ඔබ Overcode හි නවතම අනුවාදය ධාවනය කරයි.",
