export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Overcode",
  ...
  "desktop.menu.ariaLabel": "Meniu Overcode",
  ...
  "desktop.recovery.loadFailed": "Overcode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Overcode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Overcode nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea Overcode a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.overcodeMissing": "overcode nu este instalat în această distribuție",
  "desktop.wsl.error.overcodeCannotRun": "overcode este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Overcode s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.overcode.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.overcode.tagline": "Modele optimizate, fiabile",
  "dialog.provider.overcodeGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Overcode",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.overcodeZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.overcodeZen.visit.prefix": "Vizitează",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Overcode.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în overcode.json",
  ...
  "dialog.server.description": "Schimbă serverul Overcode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică Overcode în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează Overcode în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează Overcode în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode este gata în {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează Overcode în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Overcode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Overcode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Overcode.",
  ...
  "help.tabs.introduction": "Overcode Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Overcode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Overcode",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (overcode.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Overcode nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Overcode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Overcode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Overcode",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Overcode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Overcode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Overcode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Overcode",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Overcode.",
