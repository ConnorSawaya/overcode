export const dict = {
  ...
  "desktop.recovery.loadFailed": "Overcode yüklənə bilmədi",
  "desktop.recovery.terminated": "Overcode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Overcode cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Overcode quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.overcodeMissing": "Bu distribütivdə overcode quraşdırılmayıb",
  "desktop.wsl.error.overcodeCannotRun": "overcode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Overcode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.overcode.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.overcode.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.overcodeGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "Overcode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Overcode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Overcode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Overcode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər overcode.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Overcode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Overcode yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Overcode yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Overcode yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Overcode yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Overcode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Overcode-u yeniləyin",
  "wsl.onboarding.overcodeReadyIn": "Overcode {{distro}}-də hazırdır.",
  "wsl.onboarding.overcodeReady": "Overcode hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Overcode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Overcode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Overcode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Overcode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Overcode-u yenidən açın.",
  ...
  "help.tabs.introduction": "Overcode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Overcode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Overcode komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (overcode.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Overcode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Overcode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Overcode serverini işlət.",
  ...
  "settings.general.row.language.description": "Overcode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Overcode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Overcode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Overcode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Overcode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Overcode-un ən son versiyasından istifadə edirsiniz.",
