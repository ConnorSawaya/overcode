...
const desktop = [
  ...
  "Kilépés",
  "Az Overcode betöltése sikertelen",
  "Az Overcode ablaka váratlanul leállt",
  "Az Overcode nem válaszol",
  ...
  "Az Overcode telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az overcode nincs telepítve ebben a disztribúcióban",
  "Az overcode telepítve van, de nem futtatható",
  "Az Overcode nincs telepítve ebben: {{distro}}",
  "Az Overcode frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.overcode.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.overcode.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.overcodeGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A Overcode ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a Overcode-ben.",
  ...
  "provider.connect.overcodeZen.line1":
    "A Overcode Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Látogatás",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a Overcode-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a Overcode-ben.",
  ...
  "dialog.plugins.empty": "Az overcode.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik Overcode szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpencode": "Overcode ellenőrzése...",
  "wsl.onboarding.checkingOpencodeIn": "Overcode ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingOpencode": "Overcode frissítése...",
  "wsl.onboarding.updatingOpencodeIn": "Overcode frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateOpencodeIn": "Frissítse a Overcode-t a {{distro}}-ben.",
  "wsl.onboarding.updateOpencode": "Frissítse a Overcode-t",
  "wsl.onboarding.overcodeReadyIn": "A Overcode készen áll a {{distro}}-ben.",
  "wsl.onboarding.overcodeReady": "A Overcode készen áll.",
  "wsl.onboarding.installOpencodeIn": "Telepítse a Overcode-t a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse a Overcode-t",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "A Overcode nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a Overcode hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A Overcode nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a Overcode programot.",
  ...
  "help.tabs.introduction": "A Overcode Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A Overcode ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a Overcode csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (overcode.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a Overcode még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A Overcode ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "Overcode asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a Overcode szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a Overcode kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a Overcode az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a Overcode a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a Overcode témáját.",
  ...
  "settings.updates.row.startup.description": "A Overcode indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a Overcode legújabb verzióját futtatja.",
