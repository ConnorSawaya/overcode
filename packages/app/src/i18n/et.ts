export const dict = {
  ...
  "desktop.recovery.loadFailed": "Overcode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Overcode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Overcode ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Overcode installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.overcodeMissing": "overcode pole sellesse distrosse installitud",
  "desktop.wsl.error.overcodeCannotRun": "overcode on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Overcode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.overcode.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.overcode.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.overcodeGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Overcode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Overcode'is.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Külastage ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Overcode.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis overcode.json",
  ...
  "dialog.server.description": "Lülitage, millise Overcode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Overcode kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Overcode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Overcode värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Overcode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Overcode jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode on valmis {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Overcode asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Overcode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Overcode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Overcode.",
  ...
  "help.tabs.introduction": "Overcode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Overcode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Overcode meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (overcode.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Overcode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Overcode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Overcode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Overcode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Overcode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Overcode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Overcode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Overcode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Overcode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Overcode uusimat versiooni.",
