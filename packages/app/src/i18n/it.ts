export const dict = {
  ...
  "dialog.provider.overcode.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.overcode.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.overcodeGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Overcode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.overcodeZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.overcodeZen.visit.prefix": "Visita ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Overcode.",
  ...
  "dialog.plugins.empty": "Plugin configurati in overcode.json",
  ...
  "dialog.server.description": "Cambia il server Overcode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Overcode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Overcode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Overcode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode è pronto in {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Overcode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Overcode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Overcode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Overcode.",
  ...
  "help.tabs.introduction": "Overcode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Overcode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Overcode",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (overcode.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Overcode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Overcode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Overcode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Overcode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Overcode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Overcode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Overcode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Overcode",
  ...
  "settings.updates.toast.latest.title": "Overcode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Overcode.",
  ...
  "desktop.menu.documentation": "Documentazione di Overcode",
  ...
  "desktop.menu.ariaLabel": "Menu Overcode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Overcode",
  "desktop.recovery.terminated": "La finestra di Overcode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Overcode non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Overcode non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.overcodeMissing": "overcode non è installato in questa distribuzione",
  "desktop.wsl.error.overcodeCannotRun": "overcode è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Overcode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
