export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Overcode",
  ...
  "desktop.menu.ariaLabel": "Menu do Overcode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Overcode",
  "desktop.recovery.terminated": "A janela do Overcode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Overcode não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Overcode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.overcodeMissing": "O overcode não está instalado nesta distribuição",
  "desktop.wsl.error.overcodeCannotRun": "O overcode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.overcodeNotInstalled": "O Overcode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Overcode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.overcode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.overcode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.overcodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Overcode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Visite ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Overcode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em overcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Overcode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Overcode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Overcode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Overcode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Overcode",
  "wsl.onboarding.overcodeReadyIn": "O Overcode está pronto em {{distro}}.",
  "wsl.onboarding.overcodeReady": "O Overcode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Overcode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Overcode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Overcode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Overcode novamente.",
  ...
  "help.tabs.introduction": "Agora, o Overcode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Overcode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Overcode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (overcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Overcode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Overcode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Overcode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Overcode",
  ...
  "settings.general.row.appearance.description": "Personalize como o Overcode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Overcode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Overcode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Overcode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Overcode.",
