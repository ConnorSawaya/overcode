export const dict = {
  ...
  "desktop.menu.documentation": "Overcode دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "Overcode لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Overcode دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Overcode جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "Overcode دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.overcodeMissing": "اس ڈسٹرو وچ overcode انسٹال نئیں اے",
  "desktop.wsl.error.overcodeCannotRun": "overcode انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.overcodeNotInstalled": "{{distro}} وچ Overcode انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Overcode دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.overcode.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.overcode.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.overcodeGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Overcode دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Overcode وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.overcodeZen.visit.prefix": "ویکھو ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Overcode وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Overcode وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "overcode.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس Overcode سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "Overcode چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ Overcode دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "Overcode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ Overcode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ Overcode نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "Overcode اپ ڈیٹ کرو",
  "wsl.onboarding.overcodeReadyIn": "Overcode {{distro}} چ تیار اے۔",
  "wsl.onboarding.overcodeReady": "Overcode تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ Overcode انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "Overcode انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Overcode دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Overcode ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Overcode دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Overcode Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Overcode ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Overcode ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (overcode.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Overcode ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Overcode چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Overcode سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Overcode لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Overcode کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Overcode سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Overcode نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Overcode لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Overcode دا تازہ ترین ورژن چلا رئے او۔",
