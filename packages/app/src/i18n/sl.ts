export const dict = {
  ...
  "desktop.menu.documentation": "Overcode Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Overcode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Overcode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Overcode se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Overcode ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.overcodeMissing": "overcode ni nameščen v tej distribuciji",
  "desktop.wsl.error.overcodeCannotRun": "overcode je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Overcode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.overcode.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.overcode.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.overcodeGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Overcode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Obisk ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Overcode.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v overcode.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Overcode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Overcode ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Overcode v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Overcode ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Overcode v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Overcode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode je pripravljen v {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Overcode v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Overcode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Overcode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Overcode.",
  ...
  "help.tabs.introduction": "Overcode Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Overcode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Overcode",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (overcode.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Overcode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Overcode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Overcode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Overcode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Overcode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Overcode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Overcode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Overcode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Overcode.",
