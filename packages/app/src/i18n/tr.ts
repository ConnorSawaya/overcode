...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Overcode yüklenemedi",
  "desktop.recovery.terminated": "Overcode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Overcode yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Overcode kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.overcodeMissing": "overcode bu dağıtımda kurulu değil",
  "desktop.wsl.error.overcodeCannotRun": "overcode kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Overcode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.overcode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.overcode.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.overcodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Overcode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Overcode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.overcodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Overcode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Overcode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler overcode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Overcode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Overcode kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Overcode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Overcode güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Overcode güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Overcode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Overcode'u güncelle",
  "wsl.onboarding.overcodeReadyIn": "{{distro}} içinde Overcode hazır.",
  "wsl.onboarding.overcodeReady": "Overcode hazır.",
  "wsl.onboarding.installOpencodeIn": "Overcode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Overcode'u kur",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Overcode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Overcode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Overcode'u tekrar açın.",
  ...
  "help.tabs.introduction": "Overcode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Overcode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Overcode ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (overcode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Overcode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Overcode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Overcode Masaüstü",
  ...
  "settings.desktop.wsl.description": "Overcode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Overcode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Overcode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Overcode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Overcode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Overcode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Overcode'un en son sürümünü kullanıyorsunuz.",
