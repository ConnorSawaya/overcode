...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Overcode failed to load",
  "desktop.recovery.terminated": "Overcode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Overcode is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Overcode installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.overcodeMissing": "overcode is not installed in this distro",
  "desktop.wsl.error.overcodeCannotRun": "overcode is installed but could not run",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Overcode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
