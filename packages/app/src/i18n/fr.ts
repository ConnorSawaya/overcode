export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Overcode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Overcode",
  "desktop.recovery.terminated": "La fenêtre Overcode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Overcode ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Overcode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.overcodeMissing": "overcode n'est pas installé dans cette distribution",
  "desktop.wsl.error.overcodeCannotRun": "overcode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Overcode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.overcode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.overcode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.overcodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Overcode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Visitez ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Overcode.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans overcode.json",
  ...
  "dialog.server.description": "Changez le serveur Overcode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Overcode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Overcode dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Overcode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode est prêt dans {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Overcode dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Overcode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Overcode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Overcode.",
  ...
  "help.tabs.introduction": "Overcode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Overcode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Overcode",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (overcode.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Overcode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Overcode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Overcode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Overcode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Overcode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Overcode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Overcode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Overcode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Overcode.",
