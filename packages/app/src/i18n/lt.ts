...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Overcode įkelti nepavyko",
  "Overcode langas netikėtai užsidarė",
  "Overcode neatsako",
  ...
  "Overcode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "overcode šiame distributyve neįdiegtas",
  "overcode įdiegtas, bet jo paleisti nepavyko",
  "Overcode neįdiegtas distributyve {{distro}}",
  "Overcode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.overcode.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.overcode.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.overcodeGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Overcode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.overcodeZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.overcodeZen.visit.prefix": "Aplankykite",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Overcode.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti overcode.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Overcode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Overcode {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Overcode {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Overcode {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode yra paruoštas {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Overcode į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Overcode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Overcode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Overcode.",
  ...
  "help.tabs.introduction": "Overcode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Overcode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Overcode komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (overcode.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Overcode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Overcode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Overcode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Overcode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Overcode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Overcode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Overcode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Overcode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Overcode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Overcode versiją.",
