export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Overcode",
  ...
  "desktop.menu.ariaLabel": "Menú de Overcode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Overcode",
  "desktop.recovery.terminated": "La ventana de Overcode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Overcode no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Overcode",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.overcodeMissing": "overcode no está instalado en esta distribución",
  "desktop.wsl.error.overcodeCannotRun": "overcode está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Overcode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.overcode.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.overcode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.overcodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Overcode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.overcodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Overcode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en overcode.json",
  ...
  "dialog.server.description": "Cambiar el servidor de Overcode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Overcode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Overcode en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Overcode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode está listo en {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Overcode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Overcode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Overcode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Overcode.",
  ...
  "help.tabs.introduction": "Overcode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Overcode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Overcode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (overcode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Overcode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Overcode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Overcode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Overcode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Overcode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Overcode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Overcode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Overcode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Overcode.",
