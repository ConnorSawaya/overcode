export const dict = {
  ...
  "dialog.provider.overcode.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.overcode.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.overcodeGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "Overcoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Overcodessa.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Avaa ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Overcodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Overcodessa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään overcode.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda Overcode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Overcodea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Overcodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Overcodea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Overcodea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Overcode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Overcode jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Overcode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Overcode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Overcode uudelleen.",
  ...
  "toast.update.description": "Overcoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Overcode-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (overcode.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Overcode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Overcode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Overcode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Overcoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Overcode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Overcode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Overcoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Overcode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Overcoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "Overcode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Overcode-valikko",
  ...
  "desktop.recovery.loadFailed": "Overcoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "Overcode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Overcode ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Overcoden asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.overcodeMissing": "overcodea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.overcodeCannotRun": "overcode on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.overcodeNotInstalled": "Overcodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Overcoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Overcode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
