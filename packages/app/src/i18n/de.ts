...
export const dict = {
  ...
  "dialog.provider.overcode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.overcode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.overcodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Overcode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Overcode zu nutzen.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Overcode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Overcode zu nutzen.",
  ...
  "dialog.plugins.empty": "In overcode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Overcode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Overcode wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Overcode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Overcode wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Overcode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Overcode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Overcode aktualisieren",
  "wsl.onboarding.overcodeReadyIn": "Overcode ist in {{distro}} bereit.",
  "wsl.onboarding.overcodeReady": "Overcode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Overcode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Overcode installieren",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Overcode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Overcode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Overcode erneut.",
  ...
  "toast.update.description": "Eine neue Version von Overcode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Overcode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (overcode.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Overcode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Overcode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Overcode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Overcode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Overcode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Overcode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Overcode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Overcode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Overcode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Overcode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Overcode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Overcode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Overcode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Overcode reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Overcode-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.overcodeMissing": "overcode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.overcodeCannotRun": "overcode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Overcode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Overcode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
