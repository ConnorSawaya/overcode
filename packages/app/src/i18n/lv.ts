export const dict = {
  ...
  "desktop.menu.documentation": "Overcode dokumentācija",
  ...
  "desktop.menu.ariaLabel": "Overcode izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt Overcode",
  "desktop.recovery.terminated": "Overcode logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "Overcode neatbild",
  ...
  "desktop.wsl.error.installOpencode": "Overcode instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.overcodeMissing": "overcode nav instalēts šajā distribūcijā",
  "desktop.wsl.error.overcodeCannotRun": "overcode ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Overcode atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.overcode.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.overcode.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.overcodeGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no Overcode",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Apmeklējiet",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus Overcode.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti overcode.json",
  ...
  "dialog.server.description": "Mainiet, pie kura Overcode servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOpencode": "Pārbaudu Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Pārbaudu Overcode distribūcijā {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atjauninu Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Atjauninu Overcode distribūcijā {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atjauniniet Overcode distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atjauniniet Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode ir gatavs.",
  "wsl.onboarding.installOpencodeIn": "Instalējiet Overcode distribūcijā {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalējiet Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms Overcode var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "Overcode neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet Overcode no jauna.",
  ...
  "help.tabs.introduction": "Overcode Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna Overcode versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu Overcode komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (overcode.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, Overcode vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "Overcode ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "Overcode darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist Overcode serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt Overcode saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā Overcode izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai Overcode sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet Overcode tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot Overcode",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko Overcode versiju.",
