...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Overcode",
  "Overcode-glugganum var óvænt lokað",
  "Overcode svarar ekki",
  ...
  "Uppsetning Overcode mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "overcode er ekki uppsett í þessari dreifingu",
  "overcode er uppsett en ekki var hægt að keyra það",
  "Overcode er ekki uppsett í {{distro}}",
  "Uppfærslu Overcode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.overcode.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.overcode.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.overcodeGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Overcode",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.overcodeZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.overcodeZen.visit.prefix": "Heimsókn",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Overcode.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í overcode.json",
  ...
  "dialog.server.description": "Skiptu um hvaða Overcode miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar Overcode í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir Overcode í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu Overcode í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode er tilbúið í {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp Overcode í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Overcode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Overcode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Overcode aftur.",
  ...
  "help.tabs.introduction": "Overcode Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Overcode ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Overcode teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (overcode.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Overcode styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Overcode inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Overcode skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Overcode netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Overcode",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Overcode lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Overcode fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Overcode er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Overcode ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Overcode.",
