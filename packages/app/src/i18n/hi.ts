export const dict = {
  ...
  "desktop.menu.documentation": "Overcode दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "Overcode मेन्यू",
  ...
  "desktop.recovery.loadFailed": "Overcode लोड नहीं हो सका",
  "desktop.recovery.terminated": "Overcode विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "Overcode प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "Overcode इंस्टॉल नहीं हो सका",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहले ही जोड़ा जा चुका है",
  "desktop.wsl.error.overcodeMissing": "इस डिस्ट्रो में overcode इंस्टॉल नहीं है",
  "desktop.wsl.error.overcodeCannotRun": "overcode इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.overcodeNotInstalled": "{{distro}} में Overcode इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "Overcode अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "dialog.provider.overcode.note": "Claude, GPT, Gemini और अधिक सहित क्यूरेटेड मॉडल",
  "dialog.provider.overcode.tagline": "विश्वसनीय अनुकूलित मॉडल",
  "dialog.provider.overcodeGo.tagline": "सभी के लिए कम लागत वाली सदस्यता",
  ...
  "dialog.model.unpaid.freeModels.title": "Overcode द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और Overcode में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen आपको कोडिंग एजेंटों के लिए चुने गए विश्वसनीय, अनुकूलित मॉडलों तक पहुँच देता है।",
  "provider.connect.overcodeZen.line2": "एक API कुंजी से आपको Claude, GPT, Gemini, GLM जैसे कई मॉडलों तक पहुँच मिलेगी।",
  "provider.connect.overcodeZen.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " अपनी API कुंजी प्राप्त करने के लिए।",
  "provider.connect.oauth.code.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.oauth.code.visit.link": "इस लिंक",
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और Overcode में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा Overcode में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.plugins.empty": "प्लगइन overcode.json में कॉन्फ़िगर किए गए हैं",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस Overcode सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpencode": "Overcode की जाँच हो रही है...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में Overcode की जाँच हो रही है...",
  "wsl.onboarding.updatingOpencode": "Overcode अपडेट हो रहा है...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में Overcode अपडेट हो रहा है...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में Overcode को अपडेट करें।",
  "wsl.onboarding.updateOpencode": "Overcode को अपडेट करें",
  "wsl.onboarding.overcodeReadyIn": "Overcode {{distro}} में तैयार है।",
  "wsl.onboarding.overcodeReady": "Overcode तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में Overcode स्थापित करें।",
  "wsl.onboarding.installOpencode": "Overcode स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Overcode द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "Overcode इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर Overcode को फिर से खोलें।",
  ...
  "help.tabs.introduction": "Overcode Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Overcode ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट Overcode टीम को करें",
  ...
  "error.chain.checkConfig": "अपने कॉन्फ़िगरेशन (overcode.json) प्रोवाइडर/मॉडल नामों की जाँच करें",
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, Overcode अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "Overcode में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर Overcode सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "Overcode के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि Overcode आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि Overcode सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि Overcode की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "Overcode लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप Overcode का नवीनतम संस्करण चला रहे हैं।",
