export const dict = {
  ...
  "desktop.recovery.loadFailed": "Overcodeを読み込めませんでした",
  "desktop.recovery.terminated": "Overcodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Overcodeが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Overcodeのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.overcodeMissing": "このディストリビューションにはovercodeがインストールされていません",
  "desktop.wsl.error.overcodeCannotRun": "overcodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.overcodeNotInstalled": "{{distro}}にはOvercodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Overcodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.overcode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.overcode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.overcodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Overcodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Overcodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.overcodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.overcodeZen.visit.prefix": " ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してOvercodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Overcodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "overcode.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するOvercodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Overcodeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のOvercodeを確認中...",
  "wsl.onboarding.updatingOpencode": "Overcodeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のOvercodeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のOvercodeを更新してください。",
  "wsl.onboarding.updateOpencode": "Overcodeを更新",
  "wsl.onboarding.overcodeReadyIn": "{{distro}}内のOvercodeの準備ができました。",
  "wsl.onboarding.overcodeReady": "Overcodeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にOvercodeをインストールしてください。",
  "wsl.onboarding.installOpencode": "Overcodeをインストール",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OvercodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Overcodeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Overcode Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Overcodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをOvercodeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (overcode.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: OvercodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Overcodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でOvercodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Overcodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのOvercodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Overcodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Overcodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Overcode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Overcode は最新バージョンです。",
