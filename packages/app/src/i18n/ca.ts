export const dict = {
  ...
  "desktop.menu.documentation": "Overcode Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Overcode.",
  ...
  "desktop.recovery.loadFailed": "Overcode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Overcode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Overcode no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de Overcode ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.overcodeMissing": "overcode no està instal·lat en aquesta distribució",
  "desktop.wsl.error.overcodeCannotRun": "overcode està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Overcode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.overcode.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.overcode.tagline": "Models optimitzats fiables",
  "dialog.provider.overcodeGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Overcode",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.overcodeZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Overcode.",
  ...
  "dialog.plugins.empty": "Connectors configurats a overcode.json",
  ...
  "dialog.server.description": "Canvia a quin Overcode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant Overcode a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant Overcode a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza Overcode a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode està llest a {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu Overcode a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Overcode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Overcode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Overcode.",
  ...
  "help.tabs.introduction": "Overcode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Overcode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Overcode.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (overcode.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Overcode encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Overcode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Overcode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Overcode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Overcode",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Overcode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Overcode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Overcode.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Overcode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Overcode.",
