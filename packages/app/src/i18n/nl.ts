export const dict = {
  ...
  "desktop.menu.documentation": "Overcode-documentatie",
  ...
  "desktop.recovery.loadFailed": "Overcode kan niet worden geladen",
  "desktop.recovery.terminated": "Het Overcode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Overcode reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Overcode is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.overcodeMissing": "overcode is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.overcodeCannotRun": "overcode is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Overcode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.overcode.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.overcode.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.overcodeGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Overcode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Overcode te gebruiken.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.overcodeZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.overcodeZen.visit.prefix": "Ga naar ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Overcode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Overcode te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in overcode.json",
  ...
  "dialog.server.description": "Wijzig met welke Overcode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Overcode controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Overcode controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Overcode bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Overcode bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Overcode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Overcode bijwerken",
  "wsl.onboarding.overcodeReadyIn": "Overcode is gereed in {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Overcode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Overcode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Overcode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Overcode opnieuw.",
  ...
  "help.tabs.introduction": "Overcode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Overcode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Overcode-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (overcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Overcode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Overcode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Overcode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Overcode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Overcode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Overcode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Overcode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Overcode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Overcode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Overcode.",
