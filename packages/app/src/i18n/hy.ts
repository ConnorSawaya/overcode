export const dict = {
  ...
  "desktop.menu.documentation": "Overcode Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Overcode մենյու",
  ...
  "desktop.recovery.loadFailed": "Overcode չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Overcode պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Overcode-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "Overcode տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.overcodeMissing": "overcode-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.overcodeCannotRun": "overcode-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Overcode թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.overcode.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.overcode.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.overcodeGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Overcode",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Overcode-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Այցելություն ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Overcode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Overcode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են overcode.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Overcode սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է Overcode-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է Overcode-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել Overcode-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.overcodeReady": "Overcode պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք Overcode-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Overcode-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Overcode-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Overcode։",
  ...
  "help.tabs.introduction": "Overcode Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Overcode-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Overcode թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (overcode.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Overcode-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Overcode ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Overcode սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Overcode",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Overcode տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Overcode-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Overcode-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Overcode-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Overcode-ի վերջին տարբերակը։",
