export const dict = {
  ...
  "desktop.menu.documentation": "Overcode دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Overcode مینو",
  ...
  "desktop.recovery.loadFailed": "Overcode لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Overcode ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Overcode جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "Overcode کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.overcodeMissing": "اس ڈسٹری بیوشن میں overcode انسٹال نہیں ہے",
  "desktop.wsl.error.overcodeCannotRun": "overcode انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.overcodeNotInstalled": "{{distro}} میں Overcode انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Overcode کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.overcode.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.overcode.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.overcodeGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Overcode کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Overcode میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.overcodeZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Overcode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Overcode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "overcode.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Overcode سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "Overcode چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں Overcode چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "Overcode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں Overcode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں Overcode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "Overcode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.overcodeReadyIn": "Overcode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.overcodeReady": "Overcode تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں Overcode انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "Overcode انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Overcode WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Overcode اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Overcode کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Overcode Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Overcode ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Overcode ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (overcode.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Overcode ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Overcode میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "Overcode ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Overcode سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Overcode کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Overcode کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Overcode سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Overcode کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Overcode لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Overcode کا تازہ ترین ورژن چلا رہے ہیں۔",
