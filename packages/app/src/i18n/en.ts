...
export const dict = {
  ...
  "settings.mobileAccess.deviceOnline": "Online now",
  "settings.mobileAccess.deviceLastSeen": "Last online {{date}}",
  "settings.mobileAccess.deviceTypeUnknown": "Android phone",
  ...
  "settings.mobileAccess.error.actionFailed": "That mobile-access action failed. Check the connection and try again.",
  ...
  "settings.syncDevices.deviceOnline": "Online now",
  "settings.syncDevices.deviceLastSeen": "Last online {{date}}",
  "settings.syncDevices.deviceTypeUnknown": "Unknown device",
  ...
  "settings.syncDevices.credentialsTitle": "Provider credentials",
  "settings.syncDevices.credentialsDescription":
    "Model preferences sync, but API keys stay on each device. Connect these providers here to use the same models.",
  "settings.syncDevices.credentialsRequired": "Credentials required on this device",
  ...
  "mobile.pairing.nameLabel": "Name this PC",
  "mobile.pairing.namePlaceholder": "Home PC",
  "mobile.pairing.connect": "Connect to PC",
  "mobile.pairing.scan": "Scan QR code",
  "mobile.pairing.cancel": "Cancel",
  ...
  "mobile.connections.title": "Connected PCs",
  "mobile.connections.switch": "Switch connected PC",
  "mobile.connections.add": "Add PC",
  "mobile.connections.forget": "Forget PC",
  ...
  "wsl.onboarding.step.opencode": "Overcode",
  ...
  "wsl.onboarding.opencodeReadyIn": "Overcode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Overcode is ready.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Overcode not installed",
  ...
  "settings.tools.assistant.description":
    "The assistant can inspect each available skill by name and description, then load a matching skill automatically. Configured remote sources are downloaded and cached by OpenCode when they are discovered.",
