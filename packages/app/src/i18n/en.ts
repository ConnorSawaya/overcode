...
export const dict = {
  "computer.title": "Your computer, shared control",
  "computer.tab": "Computer",
  "computer.description": "Share a live screen preview with this chat. Allow AI control when you want it to use your mouse and keyboard. Screenshots are sent to your selected AI model when it uses the computer tool.",
  "computer.share": "Share screen",
  "computer.connecting": "Connecting…",
  "computer.otherSession": "Another chat is sharing the computer. Stop sharing there first.",
  "computer.unavailable": "Computer control requires the Windows desktop build.",
  "computer.agent": "AI has control",
  "computer.user": "You have control",
  "computer.allow": "Allow AI control",
  "computer.stop": "Stop sharing",
  "computer.capturing": "Getting your screen…",
  "computer.preview": "Live computer screen preview",
  "computer.live": "Live preview",
  "computer.display": "Display",
  "computer.displayNumber": "Display {{number}}",
  "computer.agentHelp": "The AI can see this screen and use your mouse and keyboard. Take control whenever you need to.",
  "computer.userHelp": "Use your mouse and keyboard directly. AI input is paused until you allow control.",
  "computer.emergency": "Stop from anywhere",
  "computer.working": "Working…",
  "computer.connectionError": "Could not connect to computer control. Reopen this panel to retry.",
  "computer.controlError": "Could not change control. Check whether another chat is sharing, then try again.",
  "computer.captureError": "Could not capture this display. Stop sharing and try again.",
