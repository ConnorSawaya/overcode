export const dict = {
  ...
  "desktop.menu.documentation": "Overcode Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Overcode",
  ...
  "desktop.recovery.loadFailed": "Overcode se nepodařilo načíst",
  "desktop.recovery.terminated": "Overcode okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Overcode nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Overcode instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.overcodeMissing": "overcode není v této distribuci nainstalováno",
  "desktop.wsl.error.overcodeCannotRun": "overcode je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Overcode aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.overcode.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.overcode.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.overcodeGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Návštěva ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Overcode.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v overcode.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému Overcode serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Overcode v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Overcode v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Overcode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode je připraveno v {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Overcode do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Overcode může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Overcode nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Overcode.",
  ...
  "help.tabs.introduction": "Overcode Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Overcode ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Overcode",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (overcode.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Overcode zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Overcode obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Overcode uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Overcode",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Overcode na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Overcode následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Overcode.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Overcode",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Overcode.",
