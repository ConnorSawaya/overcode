...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Overcode 加载失败",
  "desktop.recovery.terminated": "Overcode 窗口意外终止",
  "desktop.recovery.unresponsive": "Overcode 未响应",
  ...
  "desktop.wsl.error.installOpencode": "Overcode 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.overcodeMissing": "此发行版中未安装 overcode",
  "desktop.wsl.error.overcodeCannotRun": "已安装 overcode，但无法运行",
  "desktop.wsl.error.overcodeNotInstalled": "{{distro}} 中未安装 Overcode",
  "desktop.wsl.error.updateVersion":
    "Overcode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.provider.overcode.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.overcode.tagline": "可靠的优化模型",
  "dialog.provider.overcodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Overcode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Overcode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.overcodeZen.line1": "Overcode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.overcodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.overcodeZen.visit.prefix": "访问 ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Overcode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Overcode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 overcode.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Overcode 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Overcode...",
  "wsl.onboarding.updatingOpencode": "正在更新 Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Overcode...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Overcode。",
  "wsl.onboarding.updateOpencode": "更新 Overcode",
  "wsl.onboarding.overcodeReadyIn": "{{distro}} 中的 Overcode 已就绪。",
  "wsl.onboarding.overcodeReady": "Overcode 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Overcode。",
  "wsl.onboarding.installOpencode": "安装 Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "未安装 Overcode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Overcode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Overcode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Overcode。",
  ...
  "help.tabs.introduction": "Overcode Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Overcode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Overcode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (overcode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Overcode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Overcode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Overcode 服务器。",
  ...
  "settings.general.row.language.description": "更改 Overcode 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Overcode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Overcode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Overcode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Overcode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Overcode。",
