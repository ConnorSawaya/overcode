export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Overcode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Overcode",
  "desktop.recovery.terminated": "Okno Overcode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Overcode nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Overcode",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.overcodeMissing": "Program overcode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.overcodeCannotRun": "Program overcode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Overcode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.overcode.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.overcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.overcodeGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Overcode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Overcode.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku overcode.json",
  ...
  "dialog.server.description": "Przełącz serwer Overcode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Overcode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Overcode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Overcode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Overcode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Overcode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Overcode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Overcode.",
  ...
  "help.tabs.introduction": "Overcode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Overcode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Overcode",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (overcode.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Overcode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Overcode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Overcode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Overcode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Overcode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Overcode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Overcode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Overcode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Overcode.",
