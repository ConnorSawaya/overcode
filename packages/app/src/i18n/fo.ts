export const dict = {
  ...
  "desktop.menu.documentation": "Overcode Skjøl",
  ...
  "desktop.menu.ariaLabel": "Overcode valmynd",
  ...
  "desktop.recovery.loadFailed": "Overcode miseydnaðist at heinta",
  "desktop.recovery.terminated": "Overcode vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Overcode svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "Overcode uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.overcodeMissing": "overcode er ikki sett upp í hesi distro",
  "desktop.wsl.error.overcodeCannotRun": "overcode er sett upp men kundi ikki koyra",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Overcode dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.overcode.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.overcode.tagline": "Álítandi optimerað modell",
  "dialog.provider.overcodeGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Overcode",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Overcode.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.overcodeZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.overcodeZen.visit.prefix": "Vitja ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Overcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Overcode.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í overcode.json",
  ...
  "dialog.server.description": "Skift hvønn Overcode ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna Overcode...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna Overcode í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring Overcode...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring Overcode í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør Overcode í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør Overcode",
  "wsl.onboarding.overcodeReadyIn": "Overcode er klárt í {{distro}}.",
  "wsl.onboarding.overcodeReady": "Overcode er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set Overcode upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp Overcode",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Overcode kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Overcode kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Overcode aftur.",
  ...
  "help.tabs.introduction": "Overcode Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Overcode ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Overcode toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (overcode.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Overcode stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Overcode inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Overcode Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Overcode ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Overcode",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Overcode sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Overcode fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Overcode er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Overcode byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Overcode.",
