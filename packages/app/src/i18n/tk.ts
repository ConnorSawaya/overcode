export const dict = {
  ...
  "desktop.menu.documentation": "Overcode Resminamalar",
  ...
  "desktop.menu.ariaLabel": "Overcode menýusy",
  ...
  "desktop.recovery.loadFailed": "Overcode ýükläp bilmedi",
  "desktop.recovery.terminated": "Overcode penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "Overcode jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "Overcode gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.overcodeMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.overcodeCannotRun": "overcode guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.overcodeNotInstalled": "Overcode {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "Overcode täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.overcode.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.overcode.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.overcodeGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Overcode tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we Overcode-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.overcodeZen.line1":
    "Overcode Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.overcodeZen.visit.prefix": "Sapar ",
  "provider.connect.overcodeZen.visit.link": "overcode.ai/zen",
  "provider.connect.overcodeZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Overcode-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Overcode-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "overcode.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy Overcode serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "Overcode barlamak ...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Overcode barlanýar...",
  "wsl.onboarding.updatingOpencode": "Overcode täzelenmek ...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de Overcode täzelenmek ...",
  "wsl.onboarding.updateOpencodeIn": "Overcode-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "Overcode täzeläň",
  "wsl.onboarding.overcodeReadyIn": "Overcode {{distro}}-de taýýar.",
  "wsl.onboarding.overcodeReady": "Overcode taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de Overcode guruň.",
  "wsl.onboarding.installOpencode": "Overcode guruň",
  ...
  "wsl.onboarding.distroStatus.overcodeMissing": "Overcode gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) Overcode WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "Overcode bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Overcode açyň.",
  ...
  "help.tabs.introduction": "Overcode Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin Overcode ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Overcode toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (overcode.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, Overcode entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "Overcode mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "Overcode serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "Overcode üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "Overcode enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "Overcode ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "Overcode-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "Overcode işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "Overcode-iň iň soňky wersiýasyny işleýärsiňiz.",
