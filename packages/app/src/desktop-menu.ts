  ...
  },
  {
    ...
    items: [
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/ConnorSawaya/overcode/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        labelKey: "desktop.menu.reportBug",
        href: "https://github.com/ConnorSawaya/overcode/issues/new?template=bug_report.yml",
      },
    ],
  },
]
