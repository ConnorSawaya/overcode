...
export function serverRequestHeaders(server: ServerConnection.HttpBase, directory?: string) {
  ...
  if (server.token) headers.set("x-overcode-channel-token", server.token)
