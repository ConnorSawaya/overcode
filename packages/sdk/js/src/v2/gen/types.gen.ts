...
export type Event =
  ...
  | EventSessionNextPromptQueueAdded
  | EventSessionNextPromptQueueRemoved
...
export type GlobalEvent = {
  ...
  payload:
    ...
    | SyncEventSessionNextPromptQueueAdded
    | SyncEventSessionNextPromptQueueRemoved
...
export type SessionDurableEvent =
  ...
  | SessionNextPromptQueueAdded
  | SessionNextPromptQueueRemoved
...
export type SyncEventSessionNextPromptQueueAdded = {
  type: "sync"
  id: string
  syncEvent: {
    type: "session.next.prompt.queue.added.1"
    id: string
    seq: number
    aggregateID: string
    data: {
...
export type SyncEventSessionNextPromptQueueRemoved = {
  type: "sync"
  id: string
  syncEvent: {
    type: "session.next.prompt.queue.removed.1"
    id: string
    seq: number
    aggregateID: string
    data: {
...
export type SessionNextPromptQueueAdded = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type SessionNextPromptQueueRemoved = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type EventSessionNextPromptQueueAdded = {
  id: string
  type: "session.next.prompt.queue.added"
  properties: {
    timestamp: number
...
export type EventSessionNextPromptQueueRemoved = {
  id: string
  type: "session.next.prompt.queue.removed"
  properties: {
    timestamp: number
