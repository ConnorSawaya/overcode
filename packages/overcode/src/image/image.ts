...
export class Service extends Context.Service<Service, Interface>()("@overcode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __OVERCODE_PHOTON_WASM_PATH?: string }).__OVERCODE_PHOTON_WASM_PATH =
