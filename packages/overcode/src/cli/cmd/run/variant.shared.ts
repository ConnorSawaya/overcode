...
//
// The saved variant persists across sessions in ~/.local/state/overcode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@overcode/RunVariant") {}
