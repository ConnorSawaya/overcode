...
>()("@overcode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@overcode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.OVERCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.OVERCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-overcode-directory"] || process.cwd()
}
