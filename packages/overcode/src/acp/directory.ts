...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@overcode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@overcode/ACPDirectory") {}
