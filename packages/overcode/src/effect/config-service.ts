 ...
 *   "@overcode/ServerAuthConfig",
 *   {
 *     password: Config.string("OVERCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("OVERCODE_SERVER_USERNAME").pipe(Config.withDefault("overcode")),
 *   },
 * ) {}
 *
