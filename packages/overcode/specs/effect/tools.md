...
Practical reference for the current tool-migration state in `packages/overcode`.
...
Tool tests should use the existing Effect helpers in `packages/overcode/test/lib/effect.ts`:
