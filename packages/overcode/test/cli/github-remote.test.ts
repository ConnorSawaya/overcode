...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/overcode.git")).toEqual({ owner: "sst", repo: "overcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/overcode")).toEqual({ owner: "sst", repo: "overcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/overcode.git")).toEqual({ owner: "sst", repo: "overcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/overcode")).toEqual({ owner: "sst", repo: "overcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/overcode.git")).toEqual({ owner: "sst", repo: "overcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/overcode")).toEqual({ owner: "sst", repo: "overcode" })
})
