...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips overcode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-overcode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-overcode-directory")).toBeNull()
      expect(result.get("x-overcode-workspace")).toBeNull()
