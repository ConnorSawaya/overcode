...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips overcode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-overcode-directory"]).toBeUndefined()
      expect(forwarded["x-overcode-workspace"]).toBeUndefined()
