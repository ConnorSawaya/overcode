...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OVERCODE_CALLER", () => {
    process.env["OVERCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OVERCODE_CALLER", () => {
    process.env["OVERCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OVERCODE_CALLER", () => {
    process.env["OVERCODE_CALLER"] = "unknown"
