...
export type SessionsHistoryOutput = {
  readonly data: ReadonlyArray<
    ...
    | {
        readonly id: string
        readonly metadata?: { readonly [x: string]: JsonValue }
        readonly type: "session.next.prompt.delivery.changed"
        readonly durable?: { readonly aggregateID: string; readonly seq: number; readonly version: number }
        readonly location?: { readonly directory: string; readonly workspaceID?: string }
        readonly data: {
          readonly timestamp: number
    ...
    | {
        readonly id: string
        readonly metadata?: { readonly [x: string]: JsonValue }
        readonly type: "session.next.prompt.queue.added"
        readonly durable?: { readonly aggregateID: string; readonly seq: number; readonly version: number }
        readonly location?: { readonly directory: string; readonly workspaceID?: string }
        readonly data: {
          readonly timestamp: number
    ...
    | {
        readonly id: string
        readonly metadata?: { readonly [x: string]: JsonValue }
        readonly type: "session.next.prompt.queue.removed"
        readonly durable?: { readonly aggregateID: string; readonly seq: number; readonly version: number }
        readonly location?: { readonly directory: string; readonly workspaceID?: string }
        readonly data: {
          readonly timestamp: number
          readonly sessionID: string
          readonly messageID: string
          readonly reason: "cancel" | "promote"
        }
      }
    | {
        readonly id: string
...
export type IntegrationsListOutput = {
  ...
  readonly data: ReadonlyArray<{
    ...
    readonly connections: ReadonlyArray<
      | { readonly type: "credential"; readonly id: string; readonly label: string; readonly methodID?: string }
...
export type CredentialsUpdateInput = {
  ...
  readonly label?: { readonly label?: string | undefined; readonly active?: boolean | undefined }["label"]
  readonly active?: { readonly label?: string | undefined; readonly active?: boolean | undefined }["active"]
}
