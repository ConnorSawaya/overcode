...
- Secondary audience: Overcode and other durable agent runtimes
...
Overcode and other durable runtimes need to own persistence, tool settlement,
...
Overcode should migrate to `generateTurn` / `streamTurn`, preserving its durable
